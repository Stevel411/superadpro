...
USAGE:
  ...
  # translate the 3 stream namespaces (default):
...
COST ESTIMATE (Haiku 4.5):
  ...
  namespaces across all 19 locales.
"""
...
def collect_work(en_data, target_ns, locale_data):
...
def main():
    ...
    parser.add_argument("--namespaces", default=",".join(DEFAULT_NAMESPACES),
                        help="Comma-separated list of top-level namespaces.")
    ...
    for lc in target_locales:
        ...
        work = collect_work(en_data, target_ns, locale_data)
