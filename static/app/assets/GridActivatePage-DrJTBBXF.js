const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WalletConnect-B2ZzT2b5.js","assets/vendor-Dlf1p8G5.js","assets/vendor-charts-sutgcRna.js","assets/index-CoriHOSi.js","assets/index-CKskfRr8.css"])))=>i.map(i=>d[i]);
import{az as _,ag as A,r as s,j as e,L as w,N as P,ad as T}from"./vendor-Dlf1p8G5.js";import{u as D,a as M}from"./index-CoriHOSi.js";import{u as W}from"./PurchaseConsentModal-V33EfiB8.js";import"./vendor-charts-sutgcRna.js";let f;function h(){return f||(f=T(()=>import("./WalletConnect-B2ZzT2b5.js"),__vite__mapDeps([0,1,2,3,4]))),f}const R=s.lazy(function(){return h().then(function(i){return{default:i.WalletConnectProvider}})}),G=s.lazy(function(){return h().then(function(i){return{default:i.WalletConnectGate}})}),E=s.lazy(function(){return h().then(function(i){return{default:i.WalletPayLink}})}),F="linear-gradient(135deg,#78350f,#b45309,#fbbf24)",O="linear-gradient(135deg,#064e3b,#047857,#10b981)",B=[{position:1,username:"member_a",isDirect:!0},{position:2,username:"member_b",isDirect:!1},{position:3,username:"member_c",isDirect:!1}],x=`
.gact-page {
  background:
