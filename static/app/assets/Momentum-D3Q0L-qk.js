import{r as s,j as e}from"./vendor-CcAYuhMo.js";import{C as y}from"./CategoryShell-jtxbr5NK.js";import{a as A,b as l}from"./index-sGjJ9McI.js";const j=`
...
.mmwrap .cat{font-size:9.5px;font-weight:900;letter-spacing:.05em;text-transform:uppercase;padding:3px 9px;border-radius:20px}
.mmwrap .cat.story{background:rgba(18,56,143,.1);color:var(--navy2)}
.mmwrap .cat.proof{background:rgba(23,163,74,.12);color:var(--green)}
.mmwrap .cat.teach{background:rgba(240,165,42,.15);color:#a86a09}
.mmwrap .cat.offer{background:rgba(200,16,46,.1);color:var(--red)}
.mmwrap .cat.bts{background:rgba(90,101,132,.14);color:var(--muted)}
...
`,D=[["all","All"],["story","Your story"],["proof","Proof"],["teach","Teach"],["offer","Offer"],["bts","Behind the scenes"]];function I(){const[o,c]=s.useState(null),[m,z]=s.useState(0),[x,h]=s.useState(!1),[p,C]=s.useState("all"),i=()=>A("/api/al/momentum").then(a=>{a&&a.ok&&c(a)}).catch(()=>{});if(s.useEffect(()=>{i()},[]),!o)return e.jsxs(y,{children:[e.jsx("style",{children:j}),e.jsx("div",{className:"mmwrap",children:e.jsx("div",{className:"mm-load",children:"Loading your Momentum plan…"})})]});const t=o.today||{},d=t.hooks&&t.hooks.length?t.hooks:t.caption?[t.caption.split(`
`)[0]]:[],g=t.caption?t.caption.split(`
`):[],S=g.slice(1).join(`
`),f=(((d[m]||g[0]||"")+`
`+S).trim()+(t.hashtags?`

`+t.hashtags:"")).trim(),b=()=>{try{navigator.clipboard.writeText(f)}catch{}h(!0),setTimeout(()=>h(!1),1800)},w=a=>{b(),window.open(a,"_blank","noopener")},T=a=>{const r=!!(o.checklist&&o.checklist[a]);c({...o,checklist:{...o.checklist,[a]:!r}}),l("/api/al/momentum/checklist",{field:a,value:!r}).then(i).catch(i)},u=(a,r)=>{l("/api/al/momentum/plan",{idea_id:a,date:r}).then(i).catch(i)},P=a=>l(`/api/al/momentum/plan/${a}/done`,{}).then(i).catch(i),n=o.challenge,k=o.streak||0,_=(o.library||[]).filter(a=>p==="all"||a.category===p);return e.jsxs(y,{children:[e.jsx("style",{children:j}),e.jsxs("div",{className:"mmwrap",children:[e.jsxs("div",{className:"hero",children:[e.jsxs("div",{className:"hl",children:[e.jsx("div",{className:"hk",children:"AdvantageLife · Build your business"}),e.jsxs("h1",{children:["Your ",e.jsx("span",{className:"g",children:"Momentum"})," plan"]}),e.jsx("p",{children:"Post something today. We'll tell you what, write it for you, and keep you on a roll — because members who post are the ones who sell."})]}),e.jsxs("div",{className:"streak",children:[e.jsxs("div",{className:"big",children:["🔥 ",k]}),e.jsx("div",{className:"lbl",children:"Day streak"}),e.jsx("div",{className:"dots",children:[0,1,2,3,4,5,6].map(a=>e.jsx("span",{className:"dot"+(a<k?" on":"")},a))})]})]}),n&&e.jsxs("div",{className:"challenge",children:[e.jsx("div",{className:"ch-icon",children:"🎯"}),e.jsxs("div",{className:"ch-body",children:[e.jsx("div",{className:"ch-lbl",children:"This week's challenge"}),e.jsx("div",{className:"ch-title",children:n.title}),e.jsx("div",{className:"ch-bar",children:e.jsx("i",{style:{width:Math.min(100,Math.round(n.progress/(n.goal||1)*100))+"%"}})}),e.jsxs("div",{className:"ch-prog",children:[n.progress," of ",n.goal," done",n.progress>=n.goal?" — challenge complete! 🔥":""]})]}),n.reward&&e.jsxs("div",{className:"ch-reward",children:["Reward",e.jsx("b",{children:n.reward})]})]}),t.title&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"seclabel",children:"Today's post — ready to go"}),e.jsxs("div",{className:"today",children:[e.jsxs("div",{className:"t-top",children:[e.jsxs("span",{className:"fmt",children:["▶ ",t.format]}),e.jsx("span",{className:"ang",children:N(t.category)}),e.jsx("h2",{children:t.title}),t.subtitle&&e.jsx("div",{className:"sub",children:t.subtitle})]}),e.jsxs("div",{className:"body",children:[d.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"hooks-lbl",children:"Pick your hook — the first line that stops the scroll"}),e.jsx("div",{className:"hook-opts",children:d.map((a,r)=>e.jsxs("button",{className:"hook-opt"+(r===m?" on":""),onClick:()=>z(r),children:['"',a,'"']},r))})]}),e.jsx("div",{className:"cap-lbl",children:"Caption — edit or use as-is"}),e.jsx("div",{className:"cap",children:f}),e.jsxs("div",{className:"acts",children:[e.jsx("button",{className:"abtn copy"+(x?" ok":""),onClick:b,children:x?"✓ Copied":"📋 Copy caption"}),t.media_url&&e.jsx("a",{className:"abtn save",href:t.media_url,download:!0,target:"_blank",rel:"noopener",children:"⬇ Save the graphic"}),e.jsx("button",{className:"abtn ig",onClick:()=>w("https://www.instagram.com"),children:"Post to Instagram →"}),e.jsx("button",{className:"abtn fb",onClick:()=>w("https://www.facebook.com"),children:"Post to Facebook →"})]}),t.tip&&e.jsxs("div",{className:"tip",children:["💡 ",e.jsx("b",{children:"Why this works:"})," ",t.tip]})]})]})]}),e.jsx("div",{className:"seclabel",children:"Today's momentum — the actions that make sales"}),e.jsxs("div",{className:"momentum",children:[e.jsxs("div",{className:"m-hd",children:["Keep your streak alive",e.jsx("span",{children:"Posting is step one — these turn attention into income."})]}),e.jsx("div",{className:"m-list",children:[["posted","Post today's content"],["shared","Share your link"],["followed_up","Follow up a lead"],["watched","Do your daily watch"]].map(([a,r])=>{const v=!!(o.checklist&&o.checklist[a]);return e.jsxs("button",{className:"m-item"+(v?" done":""),onClick:()=>T(a),children:[e.jsx("span",{className:"m-box",children:v?"✓":""})," ",r]},a)})})]}),e.jsx("div",{className:"seclabel",children:"This week's plan"}),e.jsx("div",{className:"week",children:(o.week||[]).map(a=>e.jsxs("div",{className:"day"+(a.is_today?" today-d":""),children:[e.jsx("div",{className:"dn",children:a.is_today?"Today":a.day}),e.jsx("div",{className:"dd",children:a.num}),a.items.map(r=>e.jsxs("button",{className:"chip "+(r.done?"done":r.format||"post"),onClick:()=>P(r.id),title:"Tap to mark done",children:[r.done?"✓ ":"",r.title||r.format]},r.id)),e.jsx("button",{className:"add",onClick:()=>u(null,a.date),children:"+ Add"})]},a.date))}),e.jsx("div",{className:"seclabel",children:"Idea library — tap to add to your plan"}),e.jsx("div",{className:"tabs",children:D.map(([a,r])=>e.jsx("button",{className:"tab"+(p===a?" on":""),onClick:()=>C(a),children:r},a))}),e.jsx("div",{className:"lib",children:_.map(a=>e.jsxs("div",{className:"idea",children:[e.jsxs("div",{className:"ih",children:[e.jsx("span",{className:"cat "+a.category,children:N(a.category)}),e.jsx("span",{className:"fmt2",children:a.format})]}),e.jsx("div",{className:"hook",children:a.hooks&&a.hooks[0]?'"'+a.hooks[0]+'"':a.title}),e.jsx("div",{className:"desc",children:a.subtitle}),e.jsx("button",{className:"addbtn",onClick:()=>u(a.id,M()),children:"+ Add to plan"})]},a.id))})]})]})}function N(o){return{story:"Your story",proof:"Proof",teach:"Teach",offer:"Offer",bts:"Behind the scenes"}[o]||o||""}function M(){const o=new Date;return o.getFullYear()+"-"+String(o.getMonth()+1).padStart(2,"0")+"-"+String(o.getDate()).padStart(2,"0")}export{I as default};
