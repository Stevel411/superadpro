const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WalletConnect-AeUFAC3w.js","assets/vendor-CuRcxiYs.js","assets/vendor-charts-sutgcRna.js","assets/index-Dmv-T-98.js","assets/index-CLGj5myj.css"])))=>i.map(i=>d[i]);
import{b0 as S,ak as z,r as s,j as e,L as v,M as _,ah as A}from"./vendor-CuRcxiYs.js";import{u as C,a as D}from"./index-Dmv-T-98.js";import{u as M}from"./PurchaseConsentModal-DLzyF5rc.js";import"./vendor-charts-sutgcRna.js";let f;function h(){return f||(f=A(()=>import("./WalletConnect-AeUFAC3w.js"),__vite__mapDeps([0,1,2,3,4]))),f}const P=s.lazy(function(){return h().then(function(a){return{default:a.WalletConnectProvider}})}),T=s.lazy(function(){return h().then(function(a){return{default:a.WalletConnectGate}})}),G=s.lazy(function(){return h().then(function(a){return{default:a.WalletPayLink}})}),W="linear-gradient(135deg,#78350f,#b45309,#fbbf24)",E="linear-gradient(135deg,#064e3b,#047857,#10b981)",R=[{position:1,username:"member_a",isDirect:!0},{position:2,username:"member_b",isDirect:!1},{position:3,username:"member_c",isDirect:!1}],x=`
.gact-page {
  background:
