import{r as p,j as e}from"./vendor-w_O3uhpf.js";import{C as N}from"./CategoryShell-DQnPqs4a.js";import{a as M,b as h}from"./index-BZGBzcNF.js";const z=`
...
`,O=[["all","All"],["story","Your story"],["proof","Proof"],["teach","Teach"],["offer","Offer"],["bts","Behind the scenes"]];function R(){const[r,x]=p.useState(null),[g,S]=p.useState(0),[f,b]=p.useState(!1),[d,_]=p.useState("all"),i=()=>M("/api/al/momentum").then(a=>{a&&a.ok&&x(a)}).catch(()=>{});if(p.useEffect(()=>{i()},[]),!r)return e.jsxs(N,{children:[e.jsx("style",{children:z}),e.jsx("div",{className:"mmwrap",children:e.jsx("div",{className:"mm-load",children:"Loading your Momentum plan…"})})]});const o=r.today||{},l=o.hooks&&o.hooks.length?o.hooks:o.caption?[o.caption.split(`
`)[0]]:[],u=o.caption?o.caption.split(`
`):[],T=u.slice(1).join(`
`),c=(((l[g]||u[0]||"")+`
`+T).trim()+(o.hashtags?`

`+o.hashtags:"")).trim(),m=()=>{try{navigator.clipboard.writeText(c)}catch{}b(!0),setTimeout(()=>b(!1),1800)},w=typeof navigator<"u"&&/Android|iPhone|iPad|iPod|Mobile|Silk/i.test(navigator.userAgent||""),k=a=>{m(),window.open(a,"_blank","noopener")},P=r.ref_link?"https://www.facebook.com/sharer/sharer.php?u="+encodeURIComponent(r.ref_link):"https://www.facebook.com",F=async()=>{const a={text:c};r.ref_link&&(a.url=r.ref_link);try{if(o.media_url&&typeof navigator<"u"&&navigator.canShare){const s=await(await fetch(o.media_url)).blob(),j=new File([s],"advantagelife.jpg",{type:s.type||"image/jpeg"});navigator.canShare({files:[j]})&&(a.files=[j])}}catch{}if(typeof navigator<"u"&&navigator.share)try{await navigator.share(a)}catch{}else m(),window.alert("Caption copied! Open Facebook or Instagram and paste it into your post.")},A=a=>{const t=!!(r.checklist&&r.checklist[a]);x({...r,checklist:{...r.checklist,[a]:!t}}),h("/api/al/momentum/checklist",{field:a,value:!t}).then(i).catch(i)},v=(a,t)=>{h("/api/al/momentum/plan",{idea_id:a,date:t}).then(i).catch(i)},D=a=>h(`/api/al/momentum/plan/${a}/done`,{}).then(i).catch(i),n=r.challenge,y=r.streak||0,I=(r.library||[]).filter(a=>d==="all"||a.category===d);return e.jsxs(N,{children:[e.jsx("style",{children:z}),e.jsxs("div",{className:"mmwrap",children:[e.jsxs("div",{className:"hero",children:[e.jsxs("div",{className:"hl",children:[e.jsx("div",{className:"hk",children:"AdvantageLife · Build your business"}),e.jsxs("h1",{children:["Your ",e.jsx("span",{className:"g",children:"content"})," planner"]}),e.jsx("p",{children:"Post something today. We'll tell you what, write it for you, and keep you on a roll — because members who post are the ones who sell."})]}),e.jsxs("div",{className:"streak",children:[e.jsxs("div",{className:"big",children:["🔥 ",y]}),e.jsx("div",{className:"lbl",children:"Day streak"}),e.jsx("div",{className:"dots",children:[0,1,2,3,4,5,6].map(a=>e.jsx("span",{className:"dot"+(a<y?" on":"")},a))})]})]}),n&&e.jsxs("div",{className:"challenge",children:[e.jsx("div",{className:"ch-icon",children:"🎯"}),e.jsxs("div",{className:"ch-body",children:[e.jsx("div",{className:"ch-lbl",children:"This week's challenge"}),e.jsx("div",{className:"ch-title",children:n.title}),e.jsx("div",{className:"ch-bar",children:e.jsx("i",{style:{width:Math.min(100,Math.round(n.progress/(n.goal||1)*100))+"%"}})}),e.jsxs("div",{className:"ch-prog",children:[n.progress," of ",n.goal," done",n.progress>=n.goal?" — challenge complete! 🔥":""]})]}),n.reward&&e.jsxs("div",{className:"ch-reward",children:["Reward",e.jsx("b",{children:n.reward})]})]}),o.title&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"seclabel",children:"Today's post — ready to go"}),e.jsxs("div",{className:"today",children:[e.jsxs("div",{className:"t-top",children:[e.jsxs("span",{className:"fmt",children:["▶ ",o.format]}),e.jsx("span",{className:"ang",children:C(o.category)}),e.jsx("h2",{children:o.title}),o.subtitle&&e.jsx("div",{className:"sub",children:o.subtitle})]}),e.jsxs("div",{className:"body",children:[l.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"hooks-lbl",children:"Pick your hook — the first line that stops the scroll"}),e.jsx("div",{className:"hook-opts",children:l.map((a,t)=>e.jsxs("button",{className:"hook-opt"+(t===g?" on":""),onClick:()=>S(t),children:['"',a,'"']},t))})]}),e.jsx("div",{className:"cap-lbl",children:"Caption — edit or use as-is"}),e.jsx("div",{className:"cap",children:c}),e.jsxs("div",{className:"acts",children:[e.jsx("button",{className:"abtn copy"+(f?" ok":""),onClick:m,children:f?"✓ Copied":"📋 Copy caption"}),o.media_url&&e.jsx("a",{className:"abtn save",href:o.media_url,download:!0,target:"_blank",rel:"noopener",children:"⬇ Save the graphic"}),w?e.jsx("button",{className:"abtn share",onClick:F,children:"📲 Share post →"}):e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"abtn fb",onClick:()=>k(P),children:"Open Facebook →"}),e.jsx("button",{className:"abtn ig",onClick:()=>k("https://www.instagram.com"),children:"Open Instagram →"})]})]}),e.jsx("div",{className:"sharenote",children:w?e.jsxs(e.Fragment,{children:["Tap ",e.jsx("b",{children:"Share post"})," to send your caption",o.media_url?" and graphic":""," straight into Facebook, Instagram or WhatsApp — pick the app and it's filled in."]}):e.jsxs(e.Fragment,{children:["On a computer you post through the website: we ",e.jsx("b",{children:"copy your caption"})," and open the app — just paste it in (Ctrl/Cmd + V)",o.media_url?", and drop in the graphic you saved":"","."]})}),o.tip&&e.jsxs("div",{className:"tip",children:["💡 ",e.jsx("b",{children:"Why this works:"})," ",o.tip]})]})]})]}),e.jsx("div",{className:"seclabel",children:"Today's momentum — the actions that make sales"}),e.jsxs("div",{className:"momentum",children:[e.jsxs("div",{className:"m-hd",children:["Keep your streak alive",e.jsx("span",{children:"Posting is step one — these turn attention into income."})]}),e.jsx("div",{className:"m-list",children:[["posted","Post today's content"],["shared","Share your link"],["followed_up","Follow up a lead"],["watched","Do your daily watch"]].map(([a,t])=>{const s=!!(r.checklist&&r.checklist[a]);return e.jsxs("button",{className:"m-item"+(s?" done":""),onClick:()=>A(a),children:[e.jsx("span",{className:"m-box",children:s?"✓":""})," ",t]},a)})})]}),e.jsx("div",{className:"seclabel",children:"This week's plan"}),e.jsx("div",{className:"week",children:(r.week||[]).map(a=>e.jsxs("div",{className:"day"+(a.is_today?" today-d":""),children:[e.jsx("div",{className:"dn",children:a.is_today?"Today":a.day}),e.jsx("div",{className:"dd",children:a.num}),a.items.map(t=>e.jsxs("button",{className:"chip "+(t.done?"done":t.format||"post"),onClick:()=>D(t.id),title:"Tap to mark done",children:[t.done?"✓ ":"",t.title||t.format]},t.id)),e.jsx("button",{className:"add",onClick:()=>v(null,a.date),children:"+ Add"})]},a.date))}),e.jsx("div",{className:"seclabel",children:"Idea library — tap to add to your plan"}),e.jsx("div",{className:"tabs",children:O.map(([a,t])=>e.jsx("button",{className:"tab"+(d===a?" on":""),onClick:()=>_(a),children:t},a))}),e.jsx("div",{className:"lib",children:I.map(a=>e.jsxs("div",{className:"idea",children:[e.jsxs("div",{className:"ih",children:[e.jsx("span",{className:"icat "+a.category,children:C(a.category)}),e.jsx("span",{className:"fmt2",children:a.format})]}),e.jsx("div",{className:"hook",children:a.hooks&&a.hooks[0]?'"'+a.hooks[0]+'"':a.title}),e.jsx("div",{className:"desc",children:a.subtitle}),e.jsx("button",{className:"addbtn",onClick:()=>v(a.id,Y()),children:"+ Add to plan"})]},a.id))})]})]})}function C(r){return{story:"Your story",proof:"Proof",teach:"Teach",offer:"Offer",bts:"Behind the scenes"}[r]||r||""}function Y(){const r=new Date;return r.getFullYear()+"-"+String(r.getMonth()+1).padStart(2,"0")+"-"+String(r.getDate()).padStart(2,"0")}export{R as default};
