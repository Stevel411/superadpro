const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WalletConnect-BfrIToat.js","assets/vendor-BWPk1px2.js","assets/vendor-charts-sutgcRna.js","assets/index-t-ZivSnm.js","assets/index-C8hQgkz-.css"])))=>i.map(i=>d[i]);
import{az as _,ai as A,r as s,j as e,L as w,V as P,af as T}from"./vendor-BWPk1px2.js";import{u as D,a as M}from"./index-t-ZivSnm.js";import{u as W}from"./PurchaseConsentModal-9rDZnn3r.js";import"./vendor-charts-sutgcRna.js";let f;function h(){return f||(f=T(()=>import("./WalletConnect-BfrIToat.js"),__vite__mapDeps([0,1,2,3,4]))),f}const R=s.lazy(function(){return h().then(function(i){return{default:i.WalletConnectProvider}})}),G=s.lazy(function(){return h().then(function(i){return{default:i.WalletConnectGate}})}),E=s.lazy(function(){return h().then(function(i){return{default:i.WalletPayLink}})}),F="linear-gradient(135deg,#78350f,#b45309,#fbbf24)",O="linear-gradient(135deg,#064e3b,#047857,#10b981)",B=[{position:1,username:"member_a",isDirect:!0},{position:2,username:"member_b",isDirect:!1},{position:3,username:"member_c",isDirect:!1}],x=`
.gact-page {
  background:
