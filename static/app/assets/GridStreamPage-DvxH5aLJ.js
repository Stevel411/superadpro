import{o as te,r as n,j as e,L as O}from"./vendor-CXoh5z_D.js";import"./vendor-charts-sutgcRna.js";var I=[20,50,100,200,400,600,800,1e3],J=["starter","builder","pro","advanced","elite","premium","executive","ultimate"],ae={1:"#34d399",2:"#60a5fa",3:"#a78bfa",4:"#f472b6",5:"#2dd4bf",6:"#d1d5db",7:"#fbbf24",8:"#f87171"};function oe(){var{t}=te(),[s,d]=n.useState(3),[c,Y]=n.useState(7),[b,D]=n.useState(4),[F,G]=n.useState(0),[H,g]=n.useState(function(){return Array.from({length:36},function(){return""})}),[Z,N]=n.useState(""),[_,f]=n.useState(!1),[u,m]=n.useState({tip1:!1,tip2:!1,tip3:!1}),[h,S]=n.useState(!1),[z,X]=n.useState(!0),v=n.useRef(null),x=n.useRef([]),M=n.useRef(!1);n.useEffect(function(){window.scrollTo(0,0)},[]),n.useEffect(function(){var a=null,r=103976,i=2400,o=null,l=setTimeout(function(){function A(L){a===null&&(a=L);var R=Math.min(1,(L-a)/i),ee=1-Math.pow(1-R,3);G(Math.round(r*ee)),R<1&&(o=requestAnimationFrame(A))}o=requestAnimationFrame(A)},2200);return function(){clearTimeout(l),o&&cancelAnimationFrame(o)}},[]);var p=n.useCallback(function(a){f(!1);var r=setTimeout(function(){N(a),f(!0)},220);x.current.push(r)},[]),$=n.useCallback(function(){x.current.forEach(function(a){clearTimeout(a)}),x.current=[],g(Array.from({length:36},function(){return""})),m({tip1:!1,tip2:!1,tip3:!1}),p(t("gridStream.caption.start"))},[p,t]),w=n.useCallback(function(){x.current.forEach(function(r){clearTimeout(r)}),x.current=[],g(Array.from({length:36},function(){return""})),m({tip1:!1,tip2:!1,tip3:!1}),S(!1);var a=function(r,i){var o=setTimeout(r,i);x.current.push(o)};a(function(){S(!0)},800),a(function(){g(function(r){var i=r.slice();return i[0]="you filled",i[27]="you filled",i}),p("› "+t("gridStream.caption.you"))},400),a(function(){p("› "+t("gridStream.caption.directs"));for(var r=1;r<=7;r++)(function(i){a(function(){g(function(o){var l=o.slice();return l[i]="row-1 filled",l})},(i-1)*180)})(r);a(function(){m(function(i){return Object.assign({},i,{tip1:!0})})},700)},2e3),a(function(){p("› "+t("gridStream.caption.spillover"));for(var r=8;r<24;r++)(function(i){a(function(){g(function(o){var l=o.slice();return l[i]="spillover-a filled",l})},(i-8)*60)})(r);a(function(){m(function(i){return Object.assign({},i,{tip2:!0})})},800)},5e3),a(function(){p("› "+t("gridStream.caption.fills"));for(var r=24;r<63;r++)(function(i){a(function(){g(function(o){var l=o.slice();return l[i]="spillover-b filled",l})},(i-24)*40)})(r)},7500),a(function(){p("★ "+t("gridStream.caption.complete")),g(function(r){var i=r.slice();return i[63]="completion filled",i}),m(function(r){return Object.assign({},r,{tip3:!0})})},1e4)},[p,t]);n.useEffect(function(){N(t("gridStream.caption.start")),f(!0)},[t]),n.useEffect(function(){if(v.current){var a=new IntersectionObserver(function(r){r.forEach(function(i){i.isIntersecting&&!M.current&&(M.current=!0,setTimeout(w,500))})},{threshold:.35});return a.observe(v.current),function(){a.disconnect()}}},[w]),n.useEffect(function(){return function(){x.current.forEach(function(a){clearTimeout(a)})}},[]);var y=I[s-1],B=Math.min(c,63),q=Math.max(0,63-B),W=B*y*.4,U=q*y*.0625,T=Math.round(W+U),C=Math.round(y*3.2),K=(T+C)*b,E=ae[s],V=t("gridStream.tier."+J[s-1]),Q=e.jsxs("svg",{viewBox:"0 0 48 64",children:[e.jsx("circle",{cx:"24",cy:"16",r:"10",fill:"currentColor"}),e.jsx("path",{d:"M8 56 C 8 40, 40 40, 40 56 L 40 64 L 8 64 Z",fill:"currentColor"})]});return e.jsxs("div",{className:"grid-stream-page",children:[e.jsx("style",{children:re}),e.jsx("div",{className:"ambient-bg"}),e.jsx("div",{className:"ambient-stars"}),e.jsx("nav",{className:"stream-nav",children:e.jsx("div",{className:"stream-nav-inner",children:e.jsxs(O,{to:"/explore/compensation",className:"stream-back",children:[e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",children:e.jsx("path",{d:"M19 12H5M12 19l-7-7 7-7",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),t("gridStream.backLink")]})})}),e.jsxs("section",{className:"hero",children:[e.jsx("div",{className:"hero-mark",children:e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",children:[e.jsx("rect",{x:"4",y:"4",width:"7",height:"7",rx:"1",fill:"#fff"}),e.jsx("rect",{x:"13",y:"4",width:"7",height:"7",rx:"1",fill:"#fff",opacity:".8"}),e.jsx("rect",{x:"4",y:"13",width:"7",height:"7",rx:"1",fill:"#fff",opacity:".8"}),e.jsx("rect",{x:"13",y:"13",width:"7",height:"7",rx:"1",fill:"#fff",opacity:".6"})]})}),e.jsx("div",{className:"hero-tag",children:t("gridStream.hero.tag")}),e.jsxs("h1",{className:"hero-h",children:[e.jsx("span",{className:"word w1",children:t("gridStream.hero.word1")})," ",e.jsx("span",{className:"word w2",children:t("gridStream.hero.word2")})," ",e.jsx("span",{className:"word w3",children:t("gridStream.hero.word3")}),e.jsxs("span",{className:"line2",children:[e.jsx("span",{className:"word w4",children:t("gridStream.hero.word4")})," ",e.jsx("span",{className:"word w5",children:t("gridStream.hero.word5")})]})]}),e.jsxs("div",{className:"hero-promise",children:[e.jsx("div",{className:"hero-promise-label",children:t("gridStream.hero.promiseLabel")}),e.jsxs("span",{className:"hero-promise-val",children:["$",F.toLocaleString()]}),e.jsx("div",{className:"hero-promise-sub",children:t("gridStream.hero.promiseSub")})]}),e.jsx("p",{className:"hero-sub",children:t("gridStream.hero.sub")}),e.jsxs("div",{className:"hero-stats",children:[e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"36"}),e.jsx("div",{className:"hero-stat-label",children:t("gridStream.hero.stat1Label")})]}),e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"8"}),e.jsx("div",{className:"hero-stat-label",children:t("gridStream.hero.stat2Label")})]}),e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"∞"}),e.jsx("div",{className:"hero-stat-label",children:t("gridStream.hero.stat3Label")})]})]}),e.jsx("div",{className:"hero-scroll",children:t("gridStream.hero.scroll")})]}),e.jsx("section",{className:"explainer-section",children:e.jsxs("div",{className:"explainer-card"+(z?" open":""),children:[e.jsxs("button",{type:"button",className:"explainer-toggle",onClick:function(){X(function(a){return!a})},"aria-expanded":z,children:[e.jsxs("div",{className:"explainer-toggle-left",children:[e.jsx("div",{className:"explainer-icon","aria-hidden":"true",children:"?"}),e.jsxs("div",{className:"explainer-titles",children:[e.jsx("div",{className:"explainer-headline",children:t("gridStream.explainer.headline")}),e.jsx("div",{className:"explainer-subtitle",children:t("gridStream.explainer.subtitle")})]})]}),e.jsx("div",{className:"explainer-chevron","aria-hidden":"true",children:"▾"})]}),e.jsxs("div",{className:"explainer-body",children:[e.jsxs("p",{className:"explainer-p",children:[t("gridStream.explainer.p1Pre"),e.jsx("strong",{children:t("gridStream.explainer.p1Bold")}),t("gridStream.explainer.p1Post")]}),e.jsx("p",{className:"explainer-p",children:t("gridStream.explainer.p2")}),e.jsxs("div",{className:"explainer-callout buying",children:[e.jsx("div",{className:"explainer-callout-label",children:t("gridStream.explainer.buyingLabel")}),e.jsx("div",{className:"explainer-callout-text",children:t("gridStream.explainer.buyingText")})]}),e.jsxs("div",{className:"explainer-callout tiers",children:[e.jsx("div",{className:"explainer-callout-label",children:t("gridStream.explainer.tiersLabel")}),e.jsx("div",{className:"explainer-callout-text",children:t("gridStream.explainer.tiersText")})]})]})]})}),e.jsxs("section",{className:"grid-action-section",children:[e.jsxs("div",{className:"grid-action-intro",children:[e.jsx("div",{className:"grid-action-tag",children:t("gridStream.section1.tag")}),e.jsxs("h2",{className:"grid-action-h",children:[t("gridStream.section1.title"),e.jsx("span",{className:"accent",children:t("gridStream.section1.titleAccent")})]}),e.jsx("p",{className:"grid-action-sub",children:t("gridStream.section1.sub")})]}),e.jsx("div",{className:"grid-stage",children:e.jsxs("div",{className:"grid-wrap",ref:v,children:[e.jsx("div",{className:"grid-caption-wrap",children:e.jsx("div",{className:"grid-caption"+(_?" show":""),children:Z})}),e.jsxs("div",{className:"iso-stage",children:[e.jsx("div",{className:"iso-grid",children:H.map(function(a,r){return e.jsx("div",{className:"iso-cell "+a,children:Q},r)})}),e.jsxs("div",{id:"tip-1",className:"grid-tip t-amber"+(u.tip1?" show":""),children:[e.jsx("div",{className:"grid-tip-label",children:t("gridStream.tip.directLabel")}),e.jsx("div",{className:"grid-tip-val",children:"+$160"})]}),e.jsxs("div",{id:"tip-2",className:"grid-tip t-sky"+(u.tip2?" show":""),children:[e.jsx("div",{className:"grid-tip-label",children:t("gridStream.tip.uniLabel")}),e.jsx("div",{className:"grid-tip-val",children:"+$20"})]}),e.jsxs("div",{id:"tip-3",className:"grid-tip t-purple"+(u.tip3?" show":""),children:[e.jsx("div",{className:"grid-tip-label",children:t("gridStream.tip.bonusLabel")}),e.jsx("div",{className:"grid-tip-val",children:"+$1,280"})]})]})]})}),e.jsxs("div",{className:"grid-stats",children:[e.jsxs("div",{className:"grid-stat"+(h?" in":""),children:[e.jsx("span",{className:"grid-stat-num",children:"36"}),e.jsx("div",{className:"grid-stat-label",children:t("gridStream.gridStat.seats")})]}),e.jsxs("div",{className:"grid-stat"+(h?" in":""),children:[e.jsx("span",{className:"grid-stat-num",children:"40%"}),e.jsx("div",{className:"grid-stat-label",children:t("gridStream.gridStat.direct")})]}),e.jsxs("div",{className:"grid-stat"+(h?" in":""),children:[e.jsx("span",{className:"grid-stat-num",children:"50%"}),e.jsx("div",{className:"grid-stat-label",children:t("gridStream.gridStat.uni")})]}),e.jsxs("div",{className:"grid-stat"+(h?" in":""),children:[e.jsx("span",{className:"grid-stat-num",children:"5%"}),e.jsx("div",{className:"grid-stat-label",children:t("gridStream.gridStat.bonus")})]})]}),e.jsxs("div",{className:"grid-controls",children:[e.jsx("button",{className:"grid-btn",onClick:$,children:t("gridStream.btn.reset")}),e.jsx("button",{className:"grid-btn primary",onClick:w,children:t("gridStream.btn.play")})]})]}),e.jsxs("section",{className:"section",children:[e.jsx("div",{className:"section-tag",children:t("gridStream.section2.tag")}),e.jsxs("h2",{className:"section-h",children:[t("gridStream.section2.title"),e.jsx("span",{className:"accent",children:t("gridStream.section2.titleAccent")})]}),e.jsx("p",{className:"section-sub",children:t("gridStream.section2.sub")}),e.jsxs("div",{className:"mechanic-wrap",children:[e.jsx(k,{stepNum:"01",stepData:1,title:t("gridStream.mechanic.step1Title"),desc:t("gridStream.mechanic.step1Desc"),cells:j.step1}),e.jsx(k,{stepNum:"02",stepData:2,title:t("gridStream.mechanic.step2Title"),descNode:e.jsxs(e.Fragment,{children:[t("gridStream.mechanic.step2DescPre")," ",e.jsx(P,{label:t("gridStream.term.spillover"),title:t("gridStream.term.spilloverTitle"),definition:t("gridStream.term.spilloverDef")}),t("gridStream.mechanic.step2DescPost")]}),cells:j.step2}),e.jsx(k,{stepNum:"03",stepData:3,title:t("gridStream.mechanic.step3Title"),desc:t("gridStream.mechanic.step3Desc"),cells:j.step3})]})]}),e.jsx("section",{className:"calc-section",children:e.jsxs("div",{className:"calc-wrap",children:[e.jsx("div",{className:"calc-tag",children:t("gridStream.section3.tag")}),e.jsxs("h2",{className:"calc-h",children:[t("gridStream.section3.title"),e.jsx("span",{className:"accent",children:t("gridStream.section3.titleAccent")})]}),e.jsx("p",{className:"calc-sub",children:t("gridStream.section3.sub")}),e.jsxs("div",{className:"calc-stage",children:[e.jsxs("div",{className:"calc-controls",children:[e.jsxs("div",{className:"calc-row",children:[e.jsxs("label",{style:{marginBottom:4},children:[t("gridStream.calc.tierLabel"),e.jsxs("span",{className:"v",style:{color:E,textShadow:"0 0 16px "+E+"55"},children:[s," — ",V]})]}),e.jsx("div",{className:"calc-tier-buttons",children:[1,2,3,4,5,6,7,8].map(function(a){var r=s===a;return e.jsxs("button",{className:"tier-btn"+(r?" active":""),"data-tier":a,onClick:function(){d(a)},children:[e.jsxs("div",{className:"t-num",children:["0",a]}),e.jsx("div",{className:"t-name",children:t("gridStream.tier."+J[a-1])}),e.jsxs("div",{className:"t-price",children:["$",I[a-1].toLocaleString()]})]},a)})})]}),e.jsxs("div",{className:"calc-row",children:[e.jsxs("label",{children:[t("gridStream.calc.refsLabel"),e.jsx("span",{className:"v",children:c})]}),e.jsx("input",{type:"range",min:"0",max:"36",value:c,className:"calc-slider",onChange:function(a){Y(parseInt(a.target.value))}}),e.jsxs("div",{className:"calc-slider-marks",children:[e.jsx("span",{children:"0"}),e.jsx("span",{children:"9"}),e.jsx("span",{children:"18"}),e.jsx("span",{children:"27"}),e.jsx("span",{children:"36"})]})]}),e.jsxs("div",{className:"calc-row",children:[e.jsxs("label",{children:[t("gridStream.calc.cyclesLabel"),e.jsx("span",{className:"v",children:b})]}),e.jsx("input",{type:"range",min:"0",max:"12",value:b,className:"calc-slider",onChange:function(a){D(parseInt(a.target.value))}}),e.jsxs("div",{className:"calc-slider-marks",children:[e.jsx("span",{children:"0"}),e.jsx("span",{children:"3"}),e.jsx("span",{children:"6"}),e.jsx("span",{children:"9"}),e.jsx("span",{children:"12"})]})]})]}),e.jsxs("div",{className:"calc-hero-result",children:[e.jsx("div",{className:"calc-hero-label",children:t("gridStream.calc.annualLabel")}),e.jsx("div",{className:"calc-hero-num-wrap",children:e.jsxs("span",{className:"calc-hero-num",children:["$",K.toLocaleString()]})}),e.jsx("div",{className:"calc-hero-sub",children:t("gridStream.calc.annualSub")}),e.jsx("div",{className:"calc-hero-divider"}),e.jsxs("div",{className:"calc-hero-stats",children:[e.jsxs("div",{className:"calc-hero-stat",children:[e.jsx("div",{className:"calc-hero-stat-label",children:t("gridStream.calc.cycleLabel")}),e.jsxs("div",{className:"calc-hero-stat-num",children:["$",T.toLocaleString()]}),e.jsxs("div",{className:"calc-hero-stat-sub",children:[t("gridStream.calc.cycleSubPre")," ",e.jsx(P,{label:t("gridStream.term.unilevel"),title:t("gridStream.term.unilevelTitle"),definition:t("gridStream.term.unilevelDef")}),t("gridStream.calc.cycleSubPost")]})]}),e.jsxs("div",{className:"calc-hero-stat is-bonus",children:[e.jsxs("div",{className:"calc-hero-stat-badge",children:[e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M12 2l2.39 7.36H22l-6.18 4.49L18.18 21 12 16.51 5.82 21l2.36-7.15L2 9.36h7.61z"})}),t("gridStream.calc.bonusBadge")]}),e.jsx("div",{className:"calc-hero-stat-label",children:t("gridStream.calc.bonusLabel")}),e.jsxs("div",{className:"calc-hero-stat-num",children:["$",C.toLocaleString()]}),e.jsx("div",{className:"calc-hero-stat-sub",children:t("gridStream.calc.bonusSub")})]})]})]})]})]})}),e.jsx("section",{className:"honest",children:e.jsxs("div",{className:"honest-card",children:[e.jsx("div",{className:"honest-quote-mark",children:'"'}),e.jsxs("div",{className:"honest-content",children:[e.jsx("div",{className:"honest-tag",children:t("gridStream.section4.tag")}),e.jsxs("h2",{className:"honest-h",children:[t("gridStream.section4.title"),e.jsx("span",{className:"accent",children:t("gridStream.section4.titleAccent")})]}),e.jsx("p",{dangerouslySetInnerHTML:{__html:t("gridStream.section4.p1")}}),e.jsx("p",{dangerouslySetInnerHTML:{__html:t("gridStream.section4.p2")}}),e.jsxs("div",{className:"honest-key",children:[e.jsx("div",{className:"honest-key-label",children:t("gridStream.section4.keyLabel")}),e.jsx("div",{className:"honest-key-text",children:t("gridStream.section4.keyText")})]})]})]})}),e.jsxs("section",{className:"cta",children:[e.jsxs("div",{className:"cta-h",children:[t("gridStream.cta.title"),e.jsx("span",{className:"emph",children:t("gridStream.cta.titleAccent")})]}),e.jsxs(O,{to:"/register",className:"cta-btn",children:[t("gridStream.cta.button"),e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",children:e.jsx("path",{d:"M5 12h14M13 5l7 7-7 7",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round"})})]})]})]})}function k(t){return e.jsxs("div",{className:"mechanic-step","data-step":t.stepData,children:[e.jsx("div",{className:"mechanic-illus",children:e.jsx("div",{className:"mini-grid",children:Array.from({length:36}).map(function(s,d){var c="mini-cell";return t.cells.you&&t.cells.you.indexOf(d)>=0&&(c+=" you"),t.cells.row1&&t.cells.row1.indexOf(d)>=0&&(c+=" row1"),t.cells.spill&&t.cells.spill.indexOf(d)>=0&&(c+=" spill"),t.cells.done&&t.cells.done.indexOf(d)>=0&&(c+=" done"),e.jsx("div",{className:c},d)})})}),e.jsxs("div",{className:"mechanic-text",children:[e.jsx("div",{className:"mechanic-num",children:t.stepNum}),e.jsx("div",{className:"mechanic-title",children:t.title}),e.jsx("div",{className:"mechanic-desc",children:t.descNode||t.desc})]})]})}function P(t){return e.jsxs("span",{className:"term",children:[t.label,e.jsxs("span",{className:"term-def",children:[e.jsx("strong",{children:t.title}),t.definition]})]})}var j={step1:{you:[0],row1:[1,2,3]},step2:{you:[0],row1:[1,2,3],spill:[4,5,6,7].concat(Array.from({length:12},function(t,s){return s+8}))},step3:{you:[0],row1:[1,2,3],spill:[4,5,6,7].concat(Array.from({length:23},function(t,s){return s+8})),done:[35]}},re=`
:root{
...
.explainer-headline{font-family:'Sora',sans-serif;font-size:20px;font-weight:700;color:#fff;letter-spacing:-.01em;line-height:1.3}
.explainer-subtitle{font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:.18em;text-transform:uppercase;color:var(--sky-bright);font-weight:600;margin-top:5px;opacity:.85}
...
.explainer-p{font-size:17px;line-height:1.7;color:var(--ink-80);margin:18px 0 0}
.explainer-p strong{color:var(--sky-bright);font-weight:600}

.explainer-callout{margin:18px 26px 0;padding:16px 20px;border-radius:10px}
.explainer-callout-label{font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:.2em;text-transform:uppercase;font-weight:700;margin-bottom:7px}
.explainer-callout-text{font-size:16px;line-height:1.6;color:var(--ink-80)}
...
.mini-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:5px;width:260px}
...
.iso-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:9px;width:640px;height:640px;transform:rotateX(56deg) rotateZ(-45deg);transform-style:preserve-3d;transform-origin:center center}
...
@media (max-width: 900px) {
  ...
  .explainer-headline{font-size:17px}
  .explainer-subtitle{font-size:11px}
  .explainer-body > *{padding-left:18px;padding-right:18px}
  .explainer-callout{margin-left:18px;margin-right:18px;padding:14px 16px}
