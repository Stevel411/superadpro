import{o as w,r as s,j as e,aS as b,L as y}from"./vendor-CXoh5z_D.js";import{a as j,A as x}from"./index-3x2MeR46.js";import"./vendor-charts-sutgcRna.js";const n=r=>"$"+Number(r||0).toLocaleString("en-US",{minimumFractionDigits:Number(r)%1?2:0,maximumFractionDigits:2}),N=r=>Number(r||0).toLocaleString("en-US"),k=new Set([0,2,7,9,12]),S=`
...
`;function _(){const{t:r}=w(),[c,u]=s.useState([]),[v,m]=s.useState(!0),[l,d]=s.useState(3),[g,f]=s.useState(null);if(s.useEffect(function(){const t=(new URLSearchParams(window.location.search).get("activated")||"").match(/^tier_(\d+)$/);if(t){f(parseInt(t[1]));try{window.history.replaceState({},"",window.location.pathname)}catch{}setTimeout(function(){f(null)},8e3)}},[]),s.useEffect(function(){j("/api/campaign-tiers").then(function(t){const i=(t.tiers||[]).filter(function(p){return p.tier!==0});u(i);const h=i.find(function(p){return!p.is_active});h?d(h.tier):i.length&&d(i[0].tier),m(!1)}).catch(function(){m(!1)})},[]),v)return e.jsx(x,{categoryBack:{to:"/campaigns",label:"Campaign Tiers"},title:r("campaignTiers.title"),children:e.jsxs("div",{style:{display:"flex",justifyContent:"center",padding:80},children:[e.jsx("div",{style:{width:40,height:40,border:"3px solid #e5e7eb",borderTopColor:"var(--sap-accent)",borderRadius:"50%",animation:"spin .8s linear infinite"}}),e.jsx("style",{children:"@keyframes spin{to{transform:rotate(360deg)}}"})]})});const a=c.find(function(t){return t.tier===l})||c[0];if(!a)return e.jsx(x,{categoryBack:{to:"/campaigns",label:"Campaign Tiers"},title:r("campaignTiers.title"),children:e.jsx("div",{style:{padding:40,textAlign:"center",color:"var(--sap-text-muted)"},children:"No campaign tiers available right now."})});const o=a.grid;return e.jsxs(x,{categoryBack:{to:"/campaigns",label:"Campaign Tiers"},title:r("campaignTiers.title"),children:[e.jsx("style",{children:S}),e.jsxs("div",{className:"ctcfg",children:[g!==null&&e.jsxs("div",{className:"ct-toast",children:[e.jsx(b,{size:16})," Tier ",g," activated — your campaign is live."]}),e.jsxs("div",{className:"ct-head",children:[e.jsx("span",{className:"ct-eyebrow",children:"My Business · Campaign Tiers"}),e.jsx("h1",{children:"Choose your campaign."}),e.jsx("p",{children:"Each tier runs an AI advertising campaign that delivers guaranteed views to your offer. The Profit Grid is built in if you want to earn — but the views are yours either way."})]}),e.jsx("div",{className:"ct-pills",children:c.map(function(t){return e.jsxs("button",{className:"ct-pill"+(t.tier===l?" on":""),onClick:function(){d(t.tier)},children:[t.name,t.is_active&&e.jsx("span",{className:"ct-owned",children:"✓"})]},t.tier)})}),e.jsx("div",{className:"ct-ladder",children:c.map(function(t){return e.jsx("i",{className:t.tier<=l?"fill":""},t.tier)})}),e.jsxs("div",{className:"ct-card",children:[e.jsxs("div",{className:"ct-top",children:[e.jsxs("div",{children:[e.jsx("div",{className:"ct-name",children:a.name}),e.jsx("div",{className:"ct-price",children:n(a.price)}),e.jsx("div",{className:"ct-priceunit",children:"one-time · what you pay"})]}),e.jsxs("div",{className:"ct-viewbox",children:[e.jsx("div",{className:"ct-views",children:N(a.views_target)}),e.jsx("div",{className:"ct-viewlbl",children:"ad views · what you get"})]})]}),e.jsxs("div",{className:"ct-body",children:[e.jsxs("div",{className:"ct-gridwrap",children:[e.jsx("div",{className:"ct-seats",children:Array.from({length:16}).map(function(t,i){return e.jsx("div",{className:"ct-seat "+(k.has(i)?"direct":"indirect"),style:{animationDelay:i*18+"ms"}},i)})}),e.jsx("div",{className:"ct-gridlbl",children:"16-seat Profit Grid · example fill"}),e.jsxs("div",{className:"ct-legend",children:[e.jsxs("div",{className:"ct-leg",children:[e.jsx("span",{className:"sw d"})," Direct referral — you earn 30%"]}),e.jsxs("div",{className:"ct-leg",children:[e.jsx("span",{className:"sw i"})," Indirect referral — 6.25% / level"]})]})]}),e.jsxs("div",{className:"ct-comp",children:[e.jsxs("div",{className:"ct-crow",children:[e.jsxs("div",{className:"ct-clbl",children:["Direct commission",e.jsx("small",{children:"per member you personally refer"})]}),e.jsx("div",{className:"ct-camt cyan",children:n(a.direct_commission)})]}),e.jsxs("div",{className:"ct-crow",children:[e.jsxs("div",{className:"ct-clbl",children:["Indirect commission",e.jsx("small",{children:"per fill, 8 levels deep · 6.25% each"})]}),e.jsx("div",{className:"ct-camt amber",children:n(a.uni_level_per_member)})]}),e.jsxs("div",{className:"ct-crow",children:[e.jsxs("div",{className:"ct-clbl",children:["Grid completion bonus",e.jsx("small",{children:"paid when your 16 seats fill"})]}),e.jsx("div",{className:"ct-camt cyan",children:n(a.completion_bonus)})]})]})]}),a.is_active&&o&&e.jsxs("div",{className:"ct-prog",children:[e.jsxs("div",{className:"ct-prog-top",children:[e.jsx("span",{children:"Your grid"}),e.jsxs("span",{children:[o.filled," filled · Grid #",o.advance]})]}),e.jsx("div",{className:"ct-prog-bar",children:e.jsx("div",{style:{width:(o.pct||0)+"%"}})})]}),e.jsxs("div",{className:"ct-actions",children:[a.is_active?e.jsxs("div",{className:"ct-active",children:[e.jsx(b,{size:15})," ",a.name," is active"]}):e.jsxs(y,{to:"/activate/"+a.tier,className:"ct-btn",children:["Run this campaign — ",n(a.price)," →"]}),e.jsxs("span",{className:"ct-share",children:["⚡ ",e.jsx("b",{children:"100%"})," of campaign revenue shared across the grid"]})]})]}),e.jsx("p",{className:"ct-disc",children:"Commission figures are the maximums defined by the Profit Grid and depend entirely on your own referral activity — they are not income guarantees, and many members simply use the advertising without referring anyone. Direct = 30% of tier price · indirect = 6.25% per level across 8 levels · completion bonus = the 20% grid pool. Company retains 0% of campaign revenue. All tiers are one-time payments — no subscriptions."})]})]})}export{_ as default};
