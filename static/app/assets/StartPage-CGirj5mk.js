const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ConstellationHero-NHgpYGFY.js","assets/vendor-Dlf1p8G5.js","assets/vendor-charts-sutgcRna.js","assets/vendor-three-DfyeZ56e.js"])))=>i.map(i=>d[i]);
import{r as o,j as e,ag as x,ck as a,L as m,ad as u,cl as b}from"./vendor-Dlf1p8G5.js";import{a as y,P as v,b as w}from"./index-IReVfkxt.js";import"./vendor-charts-sutgcRna.js";var j="https://videos.pexels.com/video-files/6339869/6339869-hd_1920_1080_30fps.mp4",k="https://images.pexels.com/videos/6339869/board-coffee-pause-diagrams-discussion-6339869.jpeg?auto=compress&cs=tinysrgb&w=1920";function N({src:l,poster:p,force:c}){var[h,n]=o.useState(!1),[g,d]=o.useState(!1),s=o.useRef(null);o.useEffect(function(){if(c){n(!0);return}if(typeof window<"u"&&window.matchMedia){var r=window.matchMedia("(prefers-reduced-motion: reduce)");if(r.matches)return}typeof navigator<"u"&&navigator.connection&&(navigator.connection.saveData||navigator.connection.effectiveType==="slow-2g"||navigator.connection.effectiveType==="2g")||typeof window<"u"&&window.innerWidth<600||n(!0)},[c]);function t(){if(d(!0),s.current){var r=s.current.play();r&&typeof r.catch=="function"&&r.catch(function(f){typeof console<"u"&&console.warn&&console.warn("[BackgroundVideo] autoplay denied:",f&&f.message)})}}function i(r){typeof console<"u"&&console.warn&&console.warn("[BackgroundVideo] video element error",r)}return e.jsxs("div",{className:"bg-video-wrap","aria-hidden":"true",children:[e.jsx("img",{src:p||k,alt:"",className:"bg-video-poster",loading:"eager",decoding:"async"}),h&&e.jsx("video",{ref:s,className:"bg-video"+(g?" bg-video-loaded":""),src:l||j,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",onLoadedData:t,onError:i}),e.jsx("div",{className:"bg-video-overlay"})]})}var S=o.lazy(function(){return u(()=>import("./ConstellationHero-NHgpYGFY.js"),__vite__mapDeps([0,1,2,3]))});a.registerPlugin(b);function E(){var l=o.useRef(null),p=o.useRef(null),[c,h]=o.useState({members:138,foundingRemaining:77}),[n,g]=o.useState(!1),d=x();function s(t){t&&t.preventDefault&&t.preventDefault(),!n&&(g(!0),w("/api/start/peek-next-sponsor",{}).then(function(i){var r=i&&i.sponsor_username?i.sponsor_username:"SuperAdPro";d("/register?via=start&ref="+encodeURIComponent(r))}).catch(function(){d("/register?via=start")}))}return o.useEffect(function(){y("/api/start/stats").then(function(t){t&&typeof t.total_members=="number"&&h({members:t.total_members,foundingRemaining:typeof t.founding_remaining=="number"?t.founding_remaining:77})}).catch(function(){})},[]),o.useEffect(function(){var t=a.context(function(){var i=a.utils.toArray(".hero-word");a.fromTo(i,{y:60,opacity:0},{y:0,opacity:1,duration:1.1,stagger:.09,ease:"expo.out",delay:.6}),a.fromTo(".hero-tag",{y:20,opacity:0},{y:0,opacity:1,duration:1,ease:"power2.out",delay:.3}),a.fromTo(".hero-promise",{y:30,opacity:0},{y:0,opacity:1,duration:1.2,ease:"expo.out",delay:1.5}),a.fromTo(".hero-sub",{opacity:0},{opacity:1,duration:1.4,ease:"power2.out",delay:1.9}),a.fromTo(".hero-stats > *",{y:20,opacity:0},{y:0,opacity:1,duration:1,stagger:.12,ease:"power3.out",delay:2.2}),a.fromTo(".hero-cta-row > *",{y:24,opacity:0},{y:0,opacity:1,duration:1,stagger:.18,ease:"expo.out",delay:2.55}),a.to(".hero-cta-primary",{boxShadow:"0 14px 48px rgba(6,182,212,.65), inset 0 0 0 1px rgba(255,255,255,.35)",duration:1.8,delay:3.6,repeat:-1,yoyo:!0,ease:"sine.inOut"}),a.fromTo(".fusion-left",{x:-80,opacity:0},{x:0,opacity:1,duration:1.4,ease:"expo.out",scrollTrigger:{trigger:".fusion-section",start:"top 75%"}}),a.fromTo(".fusion-right",{x:80,opacity:0},{x:0,opacity:1,duration:1.4,ease:"expo.out",scrollTrigger:{trigger:".fusion-section",start:"top 75%"}}),a.fromTo(".fusion-seam",{scale:0,opacity:0},{scale:1,opacity:1,duration:1.6,ease:"elastic.out(1, 0.5)",scrollTrigger:{trigger:".fusion-section",start:"top 70%"},delay:.4}),a.fromTo(".tool-card",{y:80,opacity:0},{y:0,opacity:1,duration:1,ease:"expo.out",stagger:.15,scrollTrigger:{trigger:".tools-section",start:"top 70%"}});var r=a.timeline({scrollTrigger:{trigger:".converge-section",start:"top top",end:"+=1200",pin:!0,scrub:.8}});r.fromTo(".converge-svg",{opacity:0,scale:.85},{opacity:1,scale:1,duration:1}).fromTo(".converge-stream-1",{strokeDashoffset:1e3},{strokeDashoffset:0,duration:1.5},"<0.2").fromTo(".converge-label-1",{opacity:0,y:20},{opacity:1,y:0,duration:.6},"<0.3").fromTo(".converge-stream-2",{strokeDashoffset:1e3},{strokeDashoffset:0,duration:1.5},"<0.2").fromTo(".converge-label-2",{opacity:0,y:20},{opacity:1,y:0,duration:.6},"<0.3").fromTo(".converge-stream-3",{strokeDashoffset:1e3},{strokeDashoffset:0,duration:1.5},"<0.2").fromTo(".converge-label-3",{opacity:0,y:20},{opacity:1,y:0,duration:.6},"<0.3").fromTo(".converge-stream-4",{strokeDashoffset:1e3},{strokeDashoffset:0,duration:1.5},"<0.2").fromTo(".converge-label-4",{opacity:0,y:20},{opacity:1,y:0,duration:.6},"<0.3").fromTo(".converge-hub",{scale:.3,opacity:0},{scale:1,opacity:1,duration:1,ease:"expo.out"},"+=0.2"),a.fromTo(".founding-price",{y:60,opacity:0,scale:.85},{y:0,opacity:1,scale:1,duration:1.6,ease:"expo.out",scrollTrigger:{trigger:".founding-section",start:"top 50%"}}),a.fromTo(".portal-headline",{y:50,opacity:0},{y:0,opacity:1,duration:1.4,ease:"expo.out",scrollTrigger:{trigger:".portal-section",start:"top 75%"}}),a.fromTo(".portal-cta",{y:30,opacity:0},{y:0,opacity:1,duration:1,ease:"expo.out",stagger:.15,delay:.3,scrollTrigger:{trigger:".portal-section",start:"top 75%"}})},l);return function(){t.revert()}},[c.foundingRemaining]),e.jsxs(v,{children:[e.jsx("style",{children:z}),e.jsxs("div",{className:"start-page",ref:l,children:[e.jsxs("section",{className:"hero-section",children:[e.jsxs("div",{className:"hero-canvas-wrap bgmode-both",children:[e.jsx(N,{force:!0}),e.jsx(o.Suspense,{fallback:e.jsx("div",{className:"hero-canvas-loading"}),children:e.jsx(S,{})}),e.jsx("div",{className:"hero-vignette"})]}),e.jsxs("div",{className:"hero-overlay",ref:p,children:[e.jsx("div",{className:"hero-tag",children:"AI marketing tools · one simple membership"}),e.jsxs("h1",{className:"hero-headline",children:[e.jsx("span",{className:"hero-word",children:"Build,"})," ",e.jsx("span",{className:"hero-word",children:"market"})," ",e.jsx("span",{className:"hero-word",children:"&"})," ",e.jsx("span",{className:"hero-word hero-word-bright",children:"earn."}),e.jsx("br",{}),e.jsxs("span",{className:"hero-headline-line2",children:[e.jsx("span",{className:"hero-word",children:"All from"})," ",e.jsx("span",{className:"hero-word hero-word-bright",children:"$20/mo."})]})]}),e.jsxs("div",{className:"hero-promise",children:[e.jsx("div",{className:"hero-promise-label",children:"// Partner membership"}),e.jsxs("span",{className:"hero-promise-val",children:["$20",e.jsx("span",{style:{fontSize:"0.4em",fontWeight:600},children:"/mo"})]}),e.jsx("div",{className:"hero-promise-sub",children:"// Full toolkit · every income stream"})]}),e.jsx("p",{className:"hero-sub",children:"One membership unlocks the entire platform — AI content tools, page and funnel builders, lead finder, autoresponder, and every income stream. Use it to grow your own business, with or without referring anyone."}),e.jsxs("div",{className:"hero-cta-row",children:[e.jsxs("a",{href:"/register?via=start",onClick:s,className:"hero-cta-primary",style:n?{pointerEvents:"none",opacity:.6}:void 0,children:[e.jsx("span",{className:"hero-cta-label",children:n?"Finding your sponsor…":"Get started free"}),e.jsx("span",{className:"hero-cta-arrow",children:"→"}),e.jsx("span",{className:"hero-cta-shimmer"})]}),e.jsx(m,{to:"#how-it-works",className:"hero-cta-ghost",children:"See how it works"})]}),e.jsxs("div",{className:"hero-stats",children:[e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"$20"}),e.jsx("div",{className:"hero-stat-label",children:"/mo membership"})]}),e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"13"}),e.jsx("div",{className:"hero-stat-label",children:"tools included"})]}),e.jsxs("div",{className:"hero-stat",children:[e.jsx("span",{className:"hero-stat-num",children:"$0"}),e.jsx("div",{className:"hero-stat-label",children:"to sign up"})]})]})]}),e.jsx("div",{className:"hero-scroll-cue",children:"Scroll into the network ↓"})]}),e.jsx("section",{className:"fusion-section beat",children:e.jsxs("div",{className:"beat-inner",children:[e.jsxs("div",{className:"beat-header",children:[e.jsx("div",{className:"beat-tag",children:"Section 02 — What it actually is"}),e.jsxs("h2",{className:"beat-h",children:["Two halves of one platform.",e.jsx("span",{className:"beat-h-accent",children:"Fused at the seam."})]}),e.jsx("p",{className:"beat-sub",children:"Most affiliate platforms have no real product. Most AI tools have no upside structure. SuperAdPro is what happens when you build both, on purpose, into one system."})]}),e.jsxs("div",{className:"fusion-grid",children:[e.jsxs("div",{className:"fusion-left fusion-side",children:[e.jsx("div",{className:"side-tag",children:"// Left half"}),e.jsx("h3",{children:"AI tools that work"}),e.jsx("p",{children:"A complete content and marketing suite. Real software with margin and substance — the kind you would pay separate subscriptions for."}),e.jsxs("ul",{children:[e.jsx("li",{children:"Creative Studio — ten AI content tools"}),e.jsx("li",{children:"Brand Poster Generator — six templates"}),e.jsx("li",{children:"Lead Finder — live web-sourced prospects"}),e.jsx("li",{children:"SuperPages — drag-and-drop landing pages"})]})]}),e.jsx("div",{className:"fusion-seam-wrap",children:e.jsx("div",{className:"fusion-seam"})}),e.jsxs("div",{className:"fusion-right fusion-side",children:[e.jsx("div",{className:"side-tag",children:"// Right half"}),e.jsx("h3",{children:"A network that compounds"}),e.jsx("p",{children:"Four income streams running on one membership. The same network powers all four — build once, earn from each."}),e.jsxs("ul",{children:[e.jsx("li",{children:"Membership commissions"}),e.jsx("li",{children:"8×8 Campaign Grid spillover"}),e.jsx("li",{children:"3×3 Credit Nexus matrix"}),e.jsx("li",{children:"Course Academy cascade"}),e.jsx("li",{children:"Transparent live commission ledger"})]})]})]})]})}),e.jsx("section",{id:"how-it-works",className:"tools-section beat",children:e.jsxs("div",{className:"beat-inner",children:[e.jsxs("div",{className:"beat-header",children:[e.jsx("div",{className:"beat-tag",children:"Section 03 — The tools"}),e.jsxs("h2",{className:"beat-h",children:["Real software for operators.",e.jsx("span",{className:"beat-h-accent",children:"Not feature theatre."})]}),e.jsx("p",{className:"beat-sub",children:"Each of these ships, runs daily, and is used by real members. Membership unlocks every one of them."})]}),e.jsx("div",{className:"tools-grid",children:[{title:"Creative Studio",desc:"Ten AI content tools under one roof. Video, images, music, voiceover, lip sync, storyboards, captions, editor, gallery, credit packs.",icon:"M12 2L2 7v10l10 5 10-5V7l-10-5z"},{title:"Brand Poster Generator",desc:"Six AI templates. Branded marketing posters in sixty seconds. Your referral link baked in automatically.",icon:"M4 4h16v16H4zM4 9h16M9 4v16"},{title:"Lead Finder",desc:"Search-driven prospect lists with live contact details. Filter by sector, geography, and intent signals.",icon:"M11 19a8 8 0 100-16 8 8 0 000 16zM21 21l-4.35-4.35"},{title:"SuperPages & Funnels",desc:"Drag-and-drop landing page builder. Eight templates, AI copy, free-form canvas, conversion tracking.",icon:"M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z M9 22V12h6v10"},{title:"MyLeads CRM",desc:"Lead capture, autoresponder with visual email timeline, AI-generated outreach. Native Brevo integration.",icon:"M2 3h20v14H2z M2 7l10 6 10-6"}].map(function(t){return e.jsxs("div",{className:"tool-card",children:[e.jsx("div",{className:"tool-icon",children:e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:t.icon})})}),e.jsx("h4",{children:t.title}),e.jsx("p",{children:t.desc})]},t.title)})})]})}),e.jsx("section",{className:"converge-section beat",children:e.jsxs("div",{className:"beat-inner converge-inner",children:[e.jsxs("div",{className:"beat-header",children:[e.jsx("div",{className:"beat-tag",children:"Section 04 — The earning"}),e.jsxs("h2",{className:"beat-h",children:["Four streams. One destination.",e.jsx("span",{className:"beat-h-accent",children:"Everything funnels back."})]}),e.jsx("p",{className:"beat-sub",children:"Most platforms ask you to stack disconnected income sources. SuperAdPro runs four streams off the same network — the activity that drives one feeds the others."})]}),e.jsxs("svg",{className:"converge-svg",viewBox:"0 0 900 480",preserveAspectRatio:"xMidYMid meet",children:[e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"streamGrad",x1:"0",y1:"0",x2:"1",y2:"0",children:[e.jsx("stop",{offset:"0",stopColor:"#22d3ee",stopOpacity:"0"}),e.jsx("stop",{offset:"0.5",stopColor:"#22d3ee",stopOpacity:"1"}),e.jsx("stop",{offset:"1",stopColor:"#0ea5e9",stopOpacity:"0.8"})]}),e.jsxs("radialGradient",{id:"hubGrad",cx:"50%",cy:"50%",r:"50%",children:[e.jsx("stop",{offset:"0",stopColor:"#ecfeff"}),e.jsx("stop",{offset:"0.4",stopColor:"#22d3ee"}),e.jsx("stop",{offset:"0.8",stopColor:"#0ea5e9"}),e.jsx("stop",{offset:"1",stopColor:"#0f172a",stopOpacity:"0"})]}),e.jsxs("filter",{id:"glow",x:"-50%",y:"-50%",width:"200%",height:"200%",children:[e.jsx("feGaussianBlur",{stdDeviation:"3",result:"blur"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"blur",operator:"over"})]})]}),e.jsx("path",{className:"converge-stream-1",d:"M100 100 Q 450 100 450 240",fill:"none",stroke:"url(#streamGrad)",strokeWidth:"2",strokeDasharray:"1000",filter:"url(#glow)"}),e.jsx("path",{className:"converge-stream-2",d:"M800 100 Q 450 100 450 240",fill:"none",stroke:"url(#streamGrad)",strokeWidth:"2",strokeDasharray:"1000",filter:"url(#glow)"}),e.jsx("path",{className:"converge-stream-3",d:"M100 380 Q 450 380 450 240",fill:"none",stroke:"url(#streamGrad)",strokeWidth:"2",strokeDasharray:"1000",filter:"url(#glow)"}),e.jsx("path",{className:"converge-stream-4",d:"M800 380 Q 450 380 450 240",fill:"none",stroke:"url(#streamGrad)",strokeWidth:"2",strokeDasharray:"1000",filter:"url(#glow)"}),e.jsxs("g",{className:"converge-label-1",children:[e.jsx("circle",{cx:"100",cy:"100",r:"10",fill:"#22d3ee"}),e.jsx("text",{x:"100",y:"74",fontFamily:"JetBrains Mono,monospace",fontSize:"12",fontWeight:"700",fill:"#22d3ee",textAnchor:"middle",letterSpacing:"3",children:"01 MEMBERSHIP"})]}),e.jsxs("g",{className:"converge-label-2",children:[e.jsx("circle",{cx:"800",cy:"100",r:"10",fill:"#22d3ee"}),e.jsx("text",{x:"800",y:"74",fontFamily:"JetBrains Mono,monospace",fontSize:"12",fontWeight:"700",fill:"#22d3ee",textAnchor:"middle",letterSpacing:"3",children:"02 GRID"})]}),e.jsxs("g",{className:"converge-label-3",children:[e.jsx("circle",{cx:"100",cy:"380",r:"10",fill:"#22d3ee"}),e.jsx("text",{x:"100",y:"412",fontFamily:"JetBrains Mono,monospace",fontSize:"12",fontWeight:"700",fill:"#22d3ee",textAnchor:"middle",letterSpacing:"3",children:"03 NEXUS"})]}),e.jsxs("g",{className:"converge-label-4",children:[e.jsx("circle",{cx:"800",cy:"380",r:"10",fill:"#22d3ee"}),e.jsx("text",{x:"800",y:"412",fontFamily:"JetBrains Mono,monospace",fontSize:"12",fontWeight:"700",fill:"#22d3ee",textAnchor:"middle",letterSpacing:"3",children:"04 ACADEMY"})]}),e.jsxs("g",{className:"converge-hub",children:[e.jsx("circle",{cx:"450",cy:"240",r:"80",fill:"url(#hubGrad)",children:e.jsx("animate",{attributeName:"r",values:"80;92;80",dur:"3.5s",repeatCount:"indefinite"})}),e.jsx("circle",{cx:"450",cy:"240",r:"36",fill:"#22d3ee"}),e.jsx("text",{x:"450",y:"247",fontFamily:"Sora,sans-serif",fontSize:"18",fontWeight:"900",fill:"#fff",textAnchor:"middle",letterSpacing:"-0.5",children:"YOU"})]})]})]})}),e.jsx("section",{className:"founding-section beat",children:e.jsxs("div",{className:"beat-inner founding-inner",children:[e.jsxs("div",{className:"beat-header",children:[e.jsx("div",{className:"beat-tag",children:"Section 05 — The membership"}),e.jsxs("h2",{className:"beat-h",children:["One membership. Everything included.",e.jsx("span",{className:"beat-h-accent",children:"No tiers, no upsells."})]})]}),e.jsxs("div",{className:"founding-price",children:[e.jsx("div",{className:"founding-price-label",children:"// Partner membership"}),e.jsx("span",{className:"founding-price-val",children:"$20"}),e.jsx("div",{className:"founding-price-foot",children:"/ month — full platform access"})]}),e.jsx("p",{className:"beat-sub",style:{maxWidth:560,margin:"24px auto 0"},children:"Every tool, every income stream, one flat price. Registration is free — activate Partner membership whenever you're ready to start earning."})]})}),e.jsx("section",{className:"portal-section beat",children:e.jsxs("div",{className:"beat-inner portal-inner",children:[e.jsxs("div",{className:"beat-header",children:[e.jsx("div",{className:"beat-tag",children:"Section 06 — The doorway"}),e.jsx("h2",{className:"portal-headline",children:"Step in."}),e.jsx("p",{className:"portal-sub portal-cta",children:"Free to join. The full toolkit is one click away at the top of this page."})]}),e.jsx("div",{className:"portal-ctas",children:e.jsx("button",{type:"button",onClick:function(){window.scrollTo({top:0,behavior:"smooth"})},className:"portal-cta portal-cta-ghost portal-back-to-top",children:"↑ Back to the top"})}),e.jsx("div",{className:"portal-signoff portal-cta",children:"Made in the UK · Built for operators"}),e.jsxs("div",{className:"portal-disclaimer portal-cta",children:["Income depends on individual effort and many other factors. No earnings are guaranteed. See the ",e.jsx(m,{to:"/income-disclaimer",style:{color:"#22d3ee"},children:"full income disclaimer"}),"."]})]})})]})]})}var z=`
