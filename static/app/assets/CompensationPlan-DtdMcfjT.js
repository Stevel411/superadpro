import{j as e}from"./vendor-CbmRKsDH.js";import{A as t}from"./index-DTqn7MIu.js";import"./vendor-charts-sutgcRna.js";var i=`
<style>
...
.cproot .cpdl{display:inline-flex;align-items:center;gap:10px;margin-top:18px;padding:13px 26px;border-radius:13px;background:linear-gradient(135deg,#0891b2,#1e3a8a);color:#fff;font-family:'Sora',sans-serif;font-weight:700;font-size:14.5px;text-decoration:none;box-shadow:0 8px 22px -8px rgba(8,145,178,.5)}
...
<div class="cpcard cppad" style="text-align:center;background:linear-gradient(160deg,#fff,#f4f8ff)">
  ...
  <div class="cpsora" style="font-size:38px;font-weight:800;color:#0f172a;margin:8px 0 4px;letter-spacing:-1px">3 Income <span style="color:#0891b2">Streams</span></div>
  ...
  <div class="cpstreamcards">
    ...
    <div class="cpstreamcard" style="border-color:#a5e8f0;background:#f0fcff"><div class="cpscn" style="color:#0891b2">STREAM 2</div><div class="cpscname">Campaign Grid</div><div class="cpscval" style="background:#cffafe;color:#0891b2">100% to members</div></div>
  ...
  <div><a class="cpdl" href="/static/downloads/income-streams/SuperAdPro-3-Income-Streams-EN.pptx?v=20260623" download><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12M7 11l5 5 5-5M5 21h14"/></svg>Download the presentation</a></div>
...
<div class="cpcard cppad">
  ...
  <div class="cpsplit">
    <div class="cpseg" style="flex:50;background:linear-gradient(135deg,#0891b2,#06b6d4)"><div class="sp">50%</div><div class="st">Direct sponsor</div></div>
    <div class="cpseg" style="flex:25;background:linear-gradient(135deg,#0ea5e9,#38bdf8)"><div class="sp">25%</div><div class="st">Uni-level &middot; 5% &times; 5</div></div>
    <div class="cpseg" style="flex:25;background:linear-gradient(135deg,#7c3aed,#a78bfa)"><div class="sp">25%</div><div class="st">Bonus pool</div></div>
  </div>
  ...
  <div class="cpgrid2">
    <div>
      <div class="cpstat" style="background:#f0fbfd"><div class="cpstatnum" style="color:#0891b2">50%</div><div><div class="cpstath" style="color:#0891b2">DIRECT COMMISSION</div><div class="cpstatd">Every referral who activates your tier pays you 50% instantly.</div></div></div>
      <div class="cpstat" style="background:#f0fbfd"><div class="cpstatnum" style="color:#0ea5e9">5%</div><div><div class="cpstath" style="color:#0891b2">UNI-LEVEL &times; 5 LEVELS</div><div class="cpstatd">Earn 5% on every position through 5 levels of depth below you.</div></div></div>
      <div class="cpstat" style="background:#f0fbfd"><div class="cpstatnum" style="color:#7c3aed">25%</div><div><div class="cpstath" style="color:#0891b2">BONUS POOL</div><div class="cpstatd">A 25% pool pays the grid owner 4&times; the tier price per full grid.</div></div></div>
      <div class="cppill" style="background:#f0fbfd;border:1.5px solid #67e8f9;color:#0891b2;margin-top:4px">100% of Campaign Grid commissions go to members</div>
    </div>
    <div>
      ...
      <div class="cpgrid4">
        ...
        <div class="cpcell" style="background:linear-gradient(140deg,#06b6d4,#22d3ee);color:#02343f">2</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#06b6d4,#22d3ee);color:#02343f">3</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#7c3aed,#a78bfa);color:#fff">4&#9733;</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#f59e0b,#fde047);color:#3a1d00">5</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#06b6d4,#22d3ee);color:#02343f">6</div>
        <div class="cpcell" style="background:#eef4f8;border:1px solid #d6e2ec;color:#aab8d4">7</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#7c3aed,#a78bfa);color:#fff">8&#9733;</div>
        <div class="cpcell" style="background:linear-gradient(140deg,#06b6d4,#22d3ee);color:#02343f">9</div>
        ...
        <div class="cpcell" style="background:linear-gradient(140deg,#7c3aed,#a78bfa);color:#fff">12&#9733;</div>
        ...
        <div class="cpcell" style="background:linear-gradient(140deg,#7c3aed,#a78bfa);color:#fff">16&#9733;</div>
      </div>
      <div style="text-align:center;font-size:11.5px;color:#64748b;margin-top:12px"><span style="color:#d97706">&#9679;</span> Direct &nbsp; <span style="color:#0891b2">&#9679;</span> Spillover &nbsp; <span style="color:#7c3aed">&#9733;</span> Bonus seats 4&middot;8&middot;12&middot;16</div>
...
<div class="cpcard cppad">
  <div class="cpeyebrow" style="color:#0891b2">Campaign Grid &middot; what each tier pays</div>
  ...
  <div class="cptablewrap"><table>
    <tr style="border-bottom:2px solid #e6ebf3"><th style="text-align:left;color:#0891b2;font-size:11px;letter-spacing:1px">TIER</th><th style="text-align:center;color:#0891b2;font-size:11px;letter-spacing:1px">PRICE</th><th style="text-align:center;color:#0891b2;font-size:11px;letter-spacing:1px">DIRECT (50%)</th><th style="text-align:center;color:#0891b2;font-size:11px;letter-spacing:1px">UNI-LEVEL (5% &times; 5)</th><th style="text-align:right;color:#0891b2;font-size:11px;letter-spacing:1px">BONUS / FULL GRID (25%)</th></tr>
    ...
    <tr style="background:#f5f9ff"><td style="font-weight:700;color:#0891b2">Champion</td><td style="text-align:center;color:#64748b">$1,000</td><td style="text-align:center;color:#64748b">$500</td><td style="text-align:center;color:#64748b">$50.00 &times; 5</td><td style="text-align:right;font-weight:800;color:#16a34a">$4,000</td></tr>
  </table></div>
  <div style="font-size:12px;color:#0891b2;font-weight:600;margin-top:12px">Uni-level shown per level &mdash; 5% on every position, 5 levels deep.</div>
...
<div class="cpcard cppad" style="background:linear-gradient(160deg,#fff,#f4f8ff)">
  <div class="cpeyebrow" style="color:#0ea5e9;text-align:center">Recap &middot; the whole system</div>
  ...
  <div class="cprecap">
    ...
    <div class="cprc"><h5 style="color:#0891b2">2 &middot; Campaign Grid</h5><li>50 / 25 / 25 &mdash; 100% to members</li><li>8 tiers, $20 to $1,000</li><li>Bonus pool $80 &rarr; $4,000</li></div>
    <div class="cprc"><h5 style="color:#7c3aed">3 &middot; Creator Credits</h5><li>20% flat to the sponsor</li><li>First buy + every repurchase</li><li>$200 pack = $40 to you</li></div>
  </div>
