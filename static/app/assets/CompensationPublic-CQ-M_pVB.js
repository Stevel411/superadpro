import{r as t,j as a,L as c}from"./vendor-PQ_usLm2.js";import"./vendor-charts-sutgcRna.js";var r=[{n:"Starter",p:20},{n:"Builder",p:50},{n:"Pro",p:100},{n:"Advanced",p:200},{n:"Premium",p:400},{n:"Elite",p:600},{n:"Master",p:800},{n:"Champion",p:1e3}],d=[4,8,12,16];function i(n){return"$"+n.toLocaleString("en-US",{minimumFractionDigits:n%1?2:0,maximumFractionDigits:2})}function g(){var n=t.useState(r[0]),o=n[0],s=n[1],p=o.p;return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:m}),a.jsxs("div",{className:"comp-plan",children:[a.jsx("div",{className:"cp-nav",children:a.jsxs("div",{className:"cp-wrap cp-nav-in",children:[a.jsxs(c,{to:"/",className:"cp-brand",children:[a.jsx("span",{className:"cp-mk",children:a.jsx("svg",{viewBox:"0 0 24 24",fill:"#fff",children:a.jsx("path",{d:"M8 5v14l11-7z"})})}),a.jsxs("span",{className:"cp-nm",children:["SuperAd",a.jsx("em",{children:"Pro"})]})]}),a.jsxs("div",{className:"cp-right",children:[a.jsx(c,{to:"/explore",className:"cp-navlink",children:"Explore"}),a.jsx(c,{to:"/register",className:"cp-btn cp-pri cp-nav-cta",children:"Create account"})]})]})}),a.jsx("section",{className:"cp-hero",children:a.jsxs("div",{className:"cp-wrap",children:[a.jsx("span",{className:"cp-eyebrow",children:"The compensation plan"}),a.jsxs("h1",{children:["See exactly how",a.jsx("br",{}),a.jsx("span",{className:"cp-g",children:"the money is shared."})]}),a.jsx("p",{className:"cp-sub",children:"AdvantageLife is an advertising platform you can earn from. Pick a pack below and see the real numbers — 100% of every pack sale goes to a member, with nothing hidden and nothing kept by the company."}),a.jsx("span",{className:"cp-disc-pill",children:"⚠️ Earnings depend on individual effort — no income is guaranteed."})]})}),a.jsx("section",{className:"cp-sec",children:a.jsxs("div",{className:"cp-wrap",children:[a.jsxs("div",{className:"cp-head",children:[a.jsx("span",{className:"cp-eyebrow",children:"First, what you're buying"}),a.jsx("h2",{children:"It's an advertising platform first"}),a.jsx("p",{children:"A VideoView pack isn't a money game — it's advertising that real people actually watch, bought from another member rather than from the company."})]}),a.jsxs("div",{className:"cp-adrow",children:[a.jsxs("div",{className:"cp-adcard",children:[a.jsx("div",{className:"cp-an",children:"1"}),a.jsx("h4",{children:"Buy a VideoView pack"}),a.jsx("p",{children:"From $10 for 1,000 views up to $1,000 for 160,000 — putting your video in front of real, logged-in members."})]}),a.jsxs("div",{className:"cp-adcard",children:[a.jsx("div",{className:"cp-an",children:"2"}),a.jsx("h4",{children:"Real people watch"}),a.jsx("p",{children:"A view only counts after 30 seconds — the standard YouTube uses. Members watch daily to stay qualified, so it's a genuinely engaged audience, not bots."})]}),a.jsxs("div",{className:"cp-adcard",children:[a.jsx("div",{className:"cp-an",children:"3"}),a.jsx("h4",{children:"100% goes to a member"}),a.jsx("p",{children:"The full pack price is paid wallet-to-wallet to the qualifying member. AdvantageLife keeps 0%."})]})]})]})}),a.jsx("section",{className:"cp-sec cp-alt",children:a.jsxs("div",{className:"cp-wrap",children:[a.jsxs("div",{className:"cp-head",children:[a.jsx("span",{className:"cp-eyebrow",children:"Interactive"}),a.jsx("h2",{children:"Explore the Campaign Grid"}),a.jsx("p",{children:"Tap a tier to see how each commission is calculated. Every figure is the live platform rate."})]}),a.jsxs("div",{className:"cp-calc",children:[a.jsxs("div",{className:"cp-calc-top",children:[a.jsxs("div",{children:[a.jsx("h3",{children:"Campaign Grid calculator"}),a.jsxs("p",{children:["Tier: ",a.jsx("span",{className:"cp-mono",children:o.n})," · seat price ",a.jsxs("span",{className:"cp-mono",children:["$",p]})]})]}),a.jsx("div",{className:"cp-badge100",children:"100% to members · 0% company"})]}),a.jsx("div",{className:"cp-tiers",children:r.map(function(e){return a.jsxs("button",{type:"button",className:"cp-tierbtn"+(e.n===o.n?" on":""),onClick:function(){s(e)},children:[e.n,a.jsxs("small",{children:["$",e.p]})]},e.n)})}),a.jsxs("div",{className:"cp-calc-body",children:[a.jsxs("div",{className:"cp-outs",children:[a.jsxs("div",{className:"cp-out d",children:[a.jsx("div",{className:"cp-oic",children:"50%"}),a.jsxs("div",{children:[a.jsx("div",{className:"cp-ot",children:"Direct commission — per member you personally sponsor"}),a.jsx("div",{className:"cp-ov",children:i(p*.5)})]})]}),a.jsxs("div",{className:"cp-out u",children:[a.jsx("div",{className:"cp-oic",children:"5%"}),a.jsxs("div",{children:[a.jsx("div",{className:"cp-ot",children:"Uni-level — per qualifying member, on each of 5 levels"}),a.jsxs("div",{className:"cp-ov",children:[i(p*.05)," ",a.jsxs("small",{children:["× 5 levels = ",i(p*.25)]})]})]})]}),a.jsxs("div",{className:"cp-out b",children:[a.jsx("div",{className:"cp-oic",children:"25%"}),a.jsxs("div",{children:[a.jsx("div",{className:"cp-ot",children:"Bonus pool — paid across a completed 16-seat grid"}),a.jsx("div",{className:"cp-ov",children:i(p*4)})]})]})]}),a.jsxs("div",{className:"cp-gridbox",children:[a.jsx("div",{className:"cp-gl",children:"4 × 4 grid · bonus paid at seats 4 · 8 · 12 · 16"}),a.jsx("div",{className:"cp-g4",children:Array.from({length:16},function(e,l){return l+1}).map(function(e){return a.jsx("div",{className:"cp-cell"+(d.indexOf(e)>=0?" bonus":""),children:e},e)})}),a.jsxs("div",{className:"cp-gcap",children:["Completed grid bonus pool: ",a.jsx("b",{children:i(p*4)})]})]})]})]})]})}),a.jsx("section",{className:"cp-sec",children:a.jsxs("div",{className:"cp-wrap",children:[a.jsxs("div",{className:"cp-head",children:[a.jsx("span",{className:"cp-eyebrow",children:"All together"}),a.jsx("h2",{children:"How the money comes back"})]}),a.jsxs("div",{className:"cp-streams",children:[a.jsxs("div",{className:"cp-scard s2",children:[a.jsx("div",{className:"cp-strip"}),a.jsx("div",{className:"cp-tag",children:"Pack sales · person to person"}),a.jsx("h4",{children:"100% to a member"}),a.jsx("p",{children:"Members buy VideoView packs, from $10 for 1,000 views up to $1,000 for 160,000. The full price is paid wallet-to-wallet to another member — AdvantageLife takes nothing."})]}),a.jsxs("div",{className:"cp-scard s1",children:[a.jsx("div",{className:"cp-strip"}),a.jsx("div",{className:"cp-tag",children:"The 3/6/9 pass-up"}),a.jsx("h4",{children:"From your 10th, all yours"}),a.jsx("p",{children:"You keep your 1st and 2nd sales; your 3rd passes up to your sponsor. Same again at 6 and 9. From your 10th sale onward, every single sale is yours."}),a.jsx("div",{className:"cp-slider-wrap",children:a.jsx("div",{className:"cp-hint",children:"You only earn on a pack level you own yourself, and only while you meet the daily watch requirement. Miss either and the sale passes to the first qualifying member above you."})})]}),a.jsxs("div",{className:"cp-scard s3",children:[a.jsx("div",{className:"cp-strip"}),a.jsx("div",{className:"cp-tag",children:"Joining · the honest bit"}),a.jsx("h4",{children:"Nobody earns from a signup"}),a.jsx("p",{children:"The $100 lifetime join pays your sponsor nothing at all — it goes to the platform. There is no monthly membership, no subscription, and no commission on anyone joining."})]})]})]})}),a.jsx("section",{className:"cp-sec cp-alt",style:{padding:"60px 0"},children:a.jsx("div",{className:"cp-wrap",children:a.jsxs("div",{className:"cp-disc-box",children:[a.jsx("b",{children:"Income disclosure."}),' The figures above are commission rates, not earnings projections. Actual income depends entirely on individual effort, the size and activity of your network, and grid completion. Many members earn little or nothing. "100% to members" applies to the Campaign Grid advertising product. No income is guaranteed.']})})}),a.jsx("section",{className:"cp-final",children:a.jsxs("div",{className:"cp-wrap",children:[a.jsx("h2",{children:"Ready to start?"}),a.jsx(c,{to:"/register",className:"cp-btn cp-pri cp-final-btn",children:"Create your free account  →"})]})}),a.jsx("div",{className:"cp-foot",children:"© 2026 SuperAdPro · Earnings depend on individual effort; no income is guaranteed."})]})]})}var m=`
.comp-plan{
