import{r as a,j as e}from"./vendor-C71l_jLw.js";import{a as x}from"./index-BZn6xUUP.js";import"./vendor-charts-sutgcRna.js";const f=`
...
`;function b(){const[r,t]=a.useState([]),[n,d]=a.useState([]),[i,l]=a.useState("all"),[p,s]=a.useState(!0);a.useEffect(function(){x("/api/al/collaborations").then(function(o){t(o&&o.items||[]),d(o&&o.categories||[]),s(!1)}).catch(function(){t([]),s(!1)})},[]);var c=i==="all"?r:r.filter(function(o){return o.category===i});return e.jsxs("div",{className:"col",children:[e.jsx("style",{children:f}),e.jsx("div",{className:"top",children:e.jsxs("div",{className:"wrap",children:[e.jsx("a",{className:"bk",href:"/dashboard",children:"← Dashboard"}),e.jsx("div",{className:"kick",children:"Things I actually use"}),e.jsx("h1",{children:"My Vetted Extras"}),e.jsx("p",{className:"sub",children:"A short list of outside opportunities I’m personally in and rate. AdvantageLife is the main event — these are extras, not replacements."})]})}),e.jsx("div",{className:"body",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:"ribbon",children:[e.jsx("span",{children:"✓"}),e.jsxs("span",{children:["Every link here carries ",e.jsx("b",{children:"my referral"})," — I only add things I’m actually in."]})]}),e.jsxs("div",{className:"discl",children:[e.jsx("b",{children:"Before you click"}),e.jsx("p",{children:"These are independent platforms. They are not AdvantageLife, I don’t run them, and I can’t control what they do. Never risk money you can’t afford to lose, and do your own checks first."})]}),n.length>1&&e.jsxs("div",{className:"bar",children:[e.jsx("button",{className:"chip"+(i==="all"?" on":""),onClick:function(){l("all")},children:"All"}),n.map(function(o){return e.jsx("button",{className:"chip"+(i===o?" on":""),onClick:function(){l(o)},children:o},o)})]}),p?e.jsx("div",{className:"load",children:"Loading…"}):c.length===0?e.jsxs("div",{className:"empty",children:[e.jsx("b",{children:"Nothing here just yet"}),e.jsx("p",{children:"I add opportunities here as I find ones worth your time. Check back soon."})]}):e.jsx("div",{className:"cards",children:c.map(function(o){return e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"cap",style:{background:"linear-gradient(90deg,"+o.logo_from+","+o.logo_to+")"}}),e.jsxs("div",{className:"in",children:[e.jsx("div",{className:"logo",style:{background:"linear-gradient(135deg,"+o.logo_from+","+o.logo_to+")"},children:o.logo_text}),e.jsx("div",{className:"cat",children:o.category}),e.jsx("h4",{children:o.name}),e.jsx("div",{className:"bl",children:o.blurb}),o.take&&e.jsx("div",{className:"take",children:o.take}),e.jsxs("div",{className:"foot",children:[e.jsx("a",{className:"go",href:"/api/al/collaborations/go/"+o.id,target:"_blank",rel:"noopener noreferrer nofollow",children:"Check it out →"}),e.jsxs("span",{className:"mine",children:[e.jsx("span",{className:"d"})," My link"]})]})]})]},o.id)})})]})})]})}export{b as default};
