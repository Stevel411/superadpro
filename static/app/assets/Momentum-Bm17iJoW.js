import{r as p,j as e}from"./vendor-w_O3uhpf.js";import{C as y}from"./CategoryShell-U5_0-kcx.js";import{a as F,b as m}from"./index-ChF9gN3O.js";const j=`
...
`,A=[["all","All"],["story","Your story"],["proof","Proof"],["teach","Teach"],["offer","Offer"],["bts","Behind the scenes"]];function H(){const[t,x]=p.useState(null),[h,z]=p.useState(0),[g,f]=p.useState(!1),[d,C]=p.useState("all"),i=()=>F("/api/al/momentum").then(a=>{a&&a.ok&&x(a)}).catch(()=>{});if(p.useEffect(()=>{i()},[]),!t)return e.jsxs(y,{children:[e.jsx("style",{children:j}),e.jsx("div",{className:"mmwrap",children:e.jsx("div",{className:"mm-load",children:"Loading your Momentum plan…"})})]});const o=t.today||{},l=o.hooks&&o.hooks.length?o.hooks:o.caption?[o.caption.split(`
`)[0]]:[],b=o.caption?o.caption.split(`
`):[],S=b.slice(1).join(`
`),c=(((l[h]||b[0]||"")+`
`+S).trim()+(o.hashtags?`

`+o.hashtags:"")).trim(),u=()=>{try{navigator.clipboard.writeText(c)}catch{}f(!0),setTimeout(()=>f(!1),1800)},T=async()=>{const a={text:c};t.ref_link&&(a.url=t.ref_link);try{if(o.media_url&&typeof navigator<"u"&&navigator.canShare){const s=await(await fetch(o.media_url)).blob(),k=new File([s],"advantagelife.jpg",{type:s.type||"image/jpeg"});navigator.canShare({files:[k]})&&(a.files=[k])}}catch{}if(typeof navigator<"u"&&navigator.share)try{await navigator.share(a)}catch{}else u(),window.alert("Caption copied! Open Facebook or Instagram and paste it into your post.")},_=a=>{const r=!!(t.checklist&&t.checklist[a]);x({...t,checklist:{...t.checklist,[a]:!r}}),m("/api/al/momentum/checklist",{field:a,value:!r}).then(i).catch(i)},w=(a,r)=>{m("/api/al/momentum/plan",{idea_id:a,date:r}).then(i).catch(i)},P=a=>m(`/api/al/momentum/plan/${a}/done`,{}).then(i).catch(i),n=t.challenge,v=t.streak||0,D=(t.library||[]).filter(a=>d==="all"||a.category===d);return e.jsxs(y,{children:[e.jsx("style",{children:j}),e.jsxs("div",{className:"mmwrap",children:[e.jsxs("div",{className:"hero",children:[e.jsxs("div",{className:"hl",children:[e.jsx("div",{className:"hk",children:"AdvantageLife · Build your business"}),e.jsxs("h1",{children:["Your ",e.jsx("span",{className:"g",children:"Momentum"})," plan"]}),e.jsx("p",{children:"Post something today. We'll tell you what, write it for you, and keep you on a roll — because members who post are the ones who sell."})]}),e.jsxs("div",{className:"streak",children:[e.jsxs("div",{className:"big",children:["🔥 ",v]}),e.jsx("div",{className:"lbl",children:"Day streak"}),e.jsx("div",{className:"dots",children:[0,1,2,3,4,5,6].map(a=>e.jsx("span",{className:"dot"+(a<v?" on":"")},a))})]})]}),n&&e.jsxs("div",{className:"challenge",children:[e.jsx("div",{className:"ch-icon",children:"🎯"}),e.jsxs("div",{className:"ch-body",children:[e.jsx("div",{className:"ch-lbl",children:"This week's challenge"}),e.jsx("div",{className:"ch-title",children:n.title}),e.jsx("div",{className:"ch-bar",children:e.jsx("i",{style:{width:Math.min(100,Math.round(n.progress/(n.goal||1)*100))+"%"}})}),e.jsxs("div",{className:"ch-prog",children:[n.progress," of ",n.goal," done",n.progress>=n.goal?" — challenge complete! 🔥":""]})]}),n.reward&&e.jsxs("div",{className:"ch-reward",children:["Reward",e.jsx("b",{children:n.reward})]})]}),o.title&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"seclabel",children:"Today's post — ready to go"}),e.jsxs("div",{className:"today",children:[e.jsxs("div",{className:"t-top",children:[e.jsxs("span",{className:"fmt",children:["▶ ",o.format]}),e.jsx("span",{className:"ang",children:N(o.category)}),e.jsx("h2",{children:o.title}),o.subtitle&&e.jsx("div",{className:"sub",children:o.subtitle})]}),e.jsxs("div",{className:"body",children:[l.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"hooks-lbl",children:"Pick your hook — the first line that stops the scroll"}),e.jsx("div",{className:"hook-opts",children:l.map((a,r)=>e.jsxs("button",{className:"hook-opt"+(r===h?" on":""),onClick:()=>z(r),children:['"',a,'"']},r))})]}),e.jsx("div",{className:"cap-lbl",children:"Caption — edit or use as-is"}),e.jsx("div",{className:"cap",children:c}),e.jsxs("div",{className:"acts",children:[e.jsx("button",{className:"abtn copy"+(g?" ok":""),onClick:u,children:g?"✓ Copied":"📋 Copy caption"}),o.media_url&&e.jsx("a",{className:"abtn save",href:o.media_url,download:!0,target:"_blank",rel:"noopener",children:"⬇ Save the graphic"}),e.jsx("button",{className:"abtn share",onClick:T,children:"📲 Share post →"})]}),e.jsxs("div",{className:"sharenote",children:["On your phone, ",e.jsx("b",{children:"Share post"})," sends your caption",o.media_url?" and graphic":""," straight into Facebook, Instagram, WhatsApp — whichever you pick. On a computer, tap ",e.jsx("b",{children:"Copy caption"}),", open the app, and paste."]}),o.tip&&e.jsxs("div",{className:"tip",children:["💡 ",e.jsx("b",{children:"Why this works:"})," ",o.tip]})]})]})]}),e.jsx("div",{className:"seclabel",children:"Today's momentum — the actions that make sales"}),e.jsxs("div",{className:"momentum",children:[e.jsxs("div",{className:"m-hd",children:["Keep your streak alive",e.jsx("span",{children:"Posting is step one — these turn attention into income."})]}),e.jsx("div",{className:"m-list",children:[["posted","Post today's content"],["shared","Share your link"],["followed_up","Follow up a lead"],["watched","Do your daily watch"]].map(([a,r])=>{const s=!!(t.checklist&&t.checklist[a]);return e.jsxs("button",{className:"m-item"+(s?" done":""),onClick:()=>_(a),children:[e.jsx("span",{className:"m-box",children:s?"✓":""})," ",r]},a)})})]}),e.jsx("div",{className:"seclabel",children:"This week's plan"}),e.jsx("div",{className:"week",children:(t.week||[]).map(a=>e.jsxs("div",{className:"day"+(a.is_today?" today-d":""),children:[e.jsx("div",{className:"dn",children:a.is_today?"Today":a.day}),e.jsx("div",{className:"dd",children:a.num}),a.items.map(r=>e.jsxs("button",{className:"chip "+(r.done?"done":r.format||"post"),onClick:()=>P(r.id),title:"Tap to mark done",children:[r.done?"✓ ":"",r.title||r.format]},r.id)),e.jsx("button",{className:"add",onClick:()=>w(null,a.date),children:"+ Add"})]},a.date))}),e.jsx("div",{className:"seclabel",children:"Idea library — tap to add to your plan"}),e.jsx("div",{className:"tabs",children:A.map(([a,r])=>e.jsx("button",{className:"tab"+(d===a?" on":""),onClick:()=>C(a),children:r},a))}),e.jsx("div",{className:"lib",children:D.map(a=>e.jsxs("div",{className:"idea",children:[e.jsxs("div",{className:"ih",children:[e.jsx("span",{className:"icat "+a.category,children:N(a.category)}),e.jsx("span",{className:"fmt2",children:a.format})]}),e.jsx("div",{className:"hook",children:a.hooks&&a.hooks[0]?'"'+a.hooks[0]+'"':a.title}),e.jsx("div",{className:"desc",children:a.subtitle}),e.jsx("button",{className:"addbtn",onClick:()=>w(a.id,M()),children:"+ Add to plan"})]},a.id))})]})]})}function N(t){return{story:"Your story",proof:"Proof",teach:"Teach",offer:"Offer",bts:"Behind the scenes"}[t]||t||""}function M(){const t=new Date;return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}export{H as default};
