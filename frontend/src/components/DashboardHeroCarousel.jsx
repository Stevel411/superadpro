...
var SLIDES = [
  ...
  },
  {
    ...
    headline: 'Just $15/month — locked for life. First 100 only.',
    body: 'One simple plan: $20/month gives you the full SuperAdPro platform — Creative Studio, the Brand Poster Generator, MyLeads CRM, the affiliate platform, AI-powered tools, the lot. The first 100 founding partners lock in $15/month for life. Cancel anytime.',
