...
export const NAV = [
  ...
  { key: 'matrix-buy', tk: 'nav.activateMatrix', label: 'Activate a Package', icon: '🚀', to: '/matrix/buy', link: true },
  { key: 'matrix', tk: 'nav.myMatrix', label: 'My Matrix', icon: '🕸️', to: '/matrix', link: false },
  { key: 'matrix-comp', tk: 'nav.howMatrixPays', label: 'How the Matrix Pays', icon: '💵', to: '/compensation-plan', link: true },
  ...
  { key: 'p2p-comp', tk: 'nav.howP2PPays', label: 'How P2P Pays', icon: '💵', to: '/compensation-plan', link: true },
  { header: 'MARKETING', icon: '📢', tk: 'nav.grpMarketing' },
