...
const btn={padding:'8px 16px',borderRadius:8,fontSize:12,fontWeight:700,border:'none',cursor:'pointer',fontFamily:'inherit',width:'100%',background:'#0ea5e9',color:'#fff'};
