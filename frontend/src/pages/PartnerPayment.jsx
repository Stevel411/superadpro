                    ...
                    <div style={{ marginTop: 14 }}>
                      ...
                      {covers ? (<>
                        ...
                        <div style={{ fontSize: 12.5, color: '#cbd5e1', textAlign: 'center', lineHeight: 1.5 }}>
                          {t('partner.renewBalanceShort', { defaultValue: 'Wallet balance $' + walletBal.toFixed(2) + ' \u2014 not enough to cover the $' + renewMonthly + ' fee. Renew by card or crypto to stay active; your balance stays yours.' })}
                        </div>
                      )}
                    </div>
                  );
