        ...
        <header className="hero">
          ...
          <div className="hero-in">
            ...
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginTop: 26, marginBottom: 10, background: '#ffffff', color: '#0a1f52', fontWeight: 900, fontSize: 15.5, padding: '15px 28px', borderRadius: 13, textDecoration: 'none', boxShadow: '0 18px 38px -12px rgba(0,0,0,.5)' }}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c8102e" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>
