...
export default function LinkTools() {
  ...
  const BASE = (typeof window !== 'undefined' ? window.location.origin : 'https://www.advantagelife.club'); // fixed: bare domain only forwards root — copied/QR links must carry www
