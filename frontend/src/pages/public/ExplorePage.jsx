...
export default function ExplorePage() {
  return (
    <div style={{ background:'#030712', color:'#fff', fontFamily:"'DM Sans',sans-serif", minHeight:'100vh' }}>
      ...
      {/* ═══ FULL SCREEN HERO — Image + Video Placeholder + Two Cards ═══ */}
      <section style={{ position:'relative', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:2, maxWidth:900, margin:'0 auto', padding:'120px 24px 60px', width:'100%', textAlign:'center' }}>

          {/* Video Placeholder */}
          <div style={{ maxWidth:720, margin:'0 auto 60px', borderRadius:20, overflow:'hidden', border:'1px solid rgba(14,165,233,0.15)', boxShadow:'0 20px 60px rgba(0,0,0,0.5)', background:'rgba(0,0,0,0.4)', backdropFilter:'blur(8px)', aspectRatio:'16/9', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', cursor:'pointer' }}>
