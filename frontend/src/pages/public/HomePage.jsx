...
.home-page .brand-hero-name em{background:linear-gradient(135deg,var(--sky-bright),var(--amber));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;font-style:normal}
