...
export default function CompensationHubPage() {
  ...
  return (
    <div className="comp-hub-page">
      <style>{compHubStyles}</style>
      ...
      <nav className="stream-nav">
        <div className="stream-nav-inner">
          <Link to="/explore" className="stream-back">
      ...
      <section className="hero" id="sec-hero">
        ...
        <div className="hero-depth" id="hero-particles"></div>
        ...
        <h1 className="hero-h">
          <span className="word w1">{t('compHub.hero.word1')}</span>{' '}
          <span className="word w2">{t('compHub.hero.word2')}</span>{' '}
          <span className="word w3">{t('compHub.hero.word3')}</span>
        </h1>

        <div className="hero-streams" id="hero-streams">
          {/* 01 Membership — active */}
          <Link to="/membership" className="hero-stream-card" data-c="green" data-delay="0">
            <div className="hero-stream-num">{t('compHub.streams.membershipNum')}</div>
            <div className="hero-stream-name">{t('compHub.streams.membershipName')}</div>
            <div className="hero-stream-tag">{t('compHub.streams.membershipTag')}</div>
          ...
          {/* 02 The Grid — active */}
          <Link to="/grid" className="hero-stream-card" data-c="indigo" data-delay="1">
            <div className="hero-stream-num">{t('compHub.streams.gridNum')}</div>
            <div className="hero-stream-name">{t('compHub.streams.gridName')}</div>
            <div className="hero-stream-tag">{t('compHub.streams.gridTag')}</div>
            <div className="hero-stream-arrow">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
          </Link>
          ...
          <div className="hero-stream-card coming-soon" data-c="amber" data-delay="3">
            ...
            <div className="hero-stream-num">{t('compHub.streams.coursesNum')}</div>
            <div className="hero-stream-name">{t('compHub.streams.coursesName')}</div>
            <div className="hero-stream-tag">{t('compHub.streams.coursesTag')}</div>
          </div>
        </div>
      </section>
    </div>
...
// ═════════ Inline styles (focused, no scaffold debt) ═════════
var compHubStyles = `
:root{
