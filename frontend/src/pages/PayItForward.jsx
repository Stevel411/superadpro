...
export default function PayItForward() {
  ...
  if (loading) return (
    <AppLayout categoryBack={{ to: '/dashboard', label: 'Dashboard' }} title={t('payItForward.title')}>
  ...
  return (
    <Suspense fallback={
      <AppLayout categoryBack={{ to: '/dashboard', label: 'Dashboard' }} title={t("payItForward.title")} subtitle={t("payItForward.subtitle")}>
    ...
    <AppLayout
      categoryBack={{ to: '/dashboard', label: 'Dashboard' }}
