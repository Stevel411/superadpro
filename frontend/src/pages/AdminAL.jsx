    ...
    <AlShell active="dashboard" back={{ to: '/dashboard', label: 'Dashboard' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto' }}>
        <div style={{ background: NAVY, borderRadius: 20, color: '#fff', padding: '22px 26px', boxShadow: '0 24px 50px -28px rgba(10,31,82,.55)', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 15, flexWrap: 'wrap' }}>
          ...
          <a href="/admin/al/payout" style={{ marginLeft: 'auto', background: '#16a34a', color: '#fff', border: '1.5px solid #16a34a', borderRadius: 10, padding: '9px 15px', fontWeight: 800, fontSize: 13, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 6, textDecoration: 'none' }}>💸 Weekly Payout</a>
          <a href="/admin/email-broadcast?e=1" style={{ background: 'rgba(255,255,255,.1)', color: '#fff', border: '1.5px solid rgba(255,255,255,.2)', borderRadius: 10, padding: '9px 15px', fontWeight: 800, fontSize: 13, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 6, textDecoration: 'none' }}>✉️ Email Members</a>
          <a href="/admin/wisdom" style={{ background: 'rgba(255,255,255,.1)', color: '#fff', border: '1.5px solid rgba(255,255,255,.2)', borderRadius: 10, padding: '9px 15px', fontWeight: 800, fontSize: 13, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 6, textDecoration: 'none' }}>Daily Wisdom</a>
