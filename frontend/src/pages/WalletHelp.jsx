...
var HELP_SECTIONS = [
  {
    ...
    items: [
      ...
      { title: 'What goes into my Campaign Wallet?', desc: 'Campaign Tier grid commissions: 30% direct sponsor commission when your referral activates a tier, 6.25% uni-level commission from 8 levels deep in your network, and grid completion bonuses when your 4×4 grid fills all 16 positions.' },
