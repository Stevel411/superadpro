  ...
  return (
    <div style={{ background: 'var(--sap-cobalt-deep)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ textAlign: 'center', padding: '32px 20px 0' }}>
        <div style={{ display: 'inline-block', fontSize: 10, fontWeight: 800, letterSpacing: 2, textTransform: 'uppercase', color: 'var(--sap-accent)', border: '1px solid rgba(14,165,233,.3)', padding: '6px 16px', borderRadius: 20, marginBottom: 12 }}>Interactive 3D Visualisation</div>
