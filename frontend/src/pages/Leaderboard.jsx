...
export default function Leaderboard() {
  ...
  var TABS = [
    ...
    { key: 'nexus',     label: t('leaderboard.nexusLabel', { defaultValue: 'Creator Credits' }),                      icon: Layers,        color: '#8b5cf6',                grad: 'linear-gradient(135deg,#6d28d9,#a78bfa)', metric: function(u){ return u._nexus_count || 0; },                  metricLabel: t('leaderboard.nexusMetric', { defaultValue: 'Credits referrals' }) },
