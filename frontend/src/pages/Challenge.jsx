...
export default function Challenge() {
  ...
  return (
    <AppLayout title="30-Day Challenge" subtitle="Your guided path to SuperAdPro success">
      ...
      {/* Hero */}
      <div style={{ background:'linear-gradient(135deg,#0f1d3a 0%,#172554 50%,#1a1050 100%)', borderRadius:20, padding:'28px 32px', marginBottom:20, position:'relative', overflow:'hidden' }}>
