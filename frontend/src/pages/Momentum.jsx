          ...
          <div className="today">
            ...
            <div className="body">
              ...
              <div className="acts">
                ...
                <button className="abtn ig" onClick={() => openApp('https://www.instagram.com')}>Post to Instagram →</button>
                <button className="abtn fb" onClick={() => openApp('https://www.facebook.com')}>Post to Facebook →</button>
              </div>
        ...
        <div className="lib">
          {lib.map((i) => (
            <div key={i.id} className="idea">
              <div className="ih"><span className={'cat ' + i.category}>{catName(i.category)}</span><span className="fmt2">{i.format}</span></div>
