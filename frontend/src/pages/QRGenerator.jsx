        ...
        <div style={{background:'#fff',border:'1px solid #e8ecf2',borderRadius:14,padding:'24px',boxShadow:'0 2px 8px rgba(0,0,0,.04)'}}>
          ...
          <div style={{display:'flex',gap:8,marginBottom:20}}>
            ...
            <button onClick={copyUrl} disabled={!url.trim()}
              ...
              {copied ? <><Check size={13} color="var(--sap-green)"/> Copied</> : <><Copy size={13}/> Copy</>}
            </button>
          </div>

          {/* Quick presets */}
          <div style={{fontSize:11,fontWeight:800,color:'var(--sap-text-muted)',textTransform:'uppercase',letterSpacing:1,marginBottom:10}}>Quick Links</div>
          ...
          {qrData ? (
            <div>
              ...
              <div style={{marginTop:20,padding:'14px',background:'var(--sap-bg-elevated)',borderRadius:10,border:'1px solid #e8ecf2'}}>
                <div style={{fontSize:11,fontWeight:800,color:'var(--sap-text-muted)',textTransform:'uppercase',letterSpacing:.8,marginBottom:6}}>Usage Tips</div>
            ...
            <div style={{padding:'60px 20px'}}>
              ...
              <div style={{fontSize:15,fontWeight:700,color:'var(--sap-text-muted)',marginBottom:6}}>Your QR Code</div>
              <div style={{fontSize:12,color:'var(--sap-text-ghost)'}}>Enter a URL and click Generate to create your QR code</div>
            </div>
          )}
        </div>
      </div>
