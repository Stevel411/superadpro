      ...
      <section style={{...sec,background:T.grad2}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{maxWidth:380,margin:'48px auto 0'}}>
            <R><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.card,border:'1px solid '+T.cardBorder}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:13,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>Lifetime access</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$100<span style={{fontSize:16,color:T.textDim,fontWeight:600}}> once</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 4px',fontWeight:700}}>Every tool, for life</div><div style={{fontSize:12,color:T.textFaint,marginBottom:20}}>One payment · Never monthly · No subscription</div>{['The full AdvantageLife toolkit','Page Builder & hosting','Email Marketing','My Blog & custom domain','Link Hub & Link Tools','Lead Finder & ProSeller','All marketing materials'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
          </div>
        </div>
      </section>
