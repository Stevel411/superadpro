      ...
      <section style={{...sec,background:T.grad2}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:24,maxWidth:680,margin:'48px auto 0'}}>
            ...
            <R delay={0.1}><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.popBg,border:'1px solid '+T.popBorder,position:'relative'}}><div style={{position:'absolute',top:-1,left:'50%',transform:'translateX(-50%)',background:T.popBadge,color:'#fff',fontFamily:"'Sora',sans-serif",fontSize:9,fontWeight:800,letterSpacing:2,padding:'4px 16px',borderRadius:'0 0 8px 8px'}}>POPULAR</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:11,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>Pro</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$35<span style={{fontSize:16,color:T.textDim,fontWeight:600}}>/mo</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 20px'}}>Full AI automation</div>{['Everything in Basic','AI Content Creator','AI Funnel Generator','SuperPages builder','Email Autoresponder','Lead Dashboard','Priority support'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
          </div>
        </div>
      </section>
