    ...
    <div style={{ background: T.bg, color: T.text, fontFamily: "'DM Sans',sans-serif", minHeight: '100vh' }}>
      ...
      <section style={{...sec,background:T.grad2}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          {/* Pricing — Founding Partner offer + standard Partner */}
          <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:24,maxWidth:680,margin:'48px auto 0'}}>
            <R delay={0.1}><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.popBg,border:'1px solid '+T.popBorder,position:'relative'}}><div style={{position:'absolute',top:-1,left:'50%',transform:'translateX(-50%)',background:'linear-gradient(135deg,#fbbf24,#f59e0b)',color:'#0a0a0a',fontFamily:"'Sora',sans-serif",fontSize:13,fontWeight:800,letterSpacing:2,padding:'4px 16px',borderRadius:'0 0 8px 8px'}}>FOUNDING · FIRST 100</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:13,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>Founding Partner</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$15<span style={{fontSize:16,color:T.textDim,fontWeight:600}}>{t('superLink.perMonth')}</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 4px',fontWeight:700}}>Locked for life</div><div style={{fontSize:12,color:T.textFaint,marginBottom:20}}>Save $5/month forever · First 100 only</div>{['Everything in Partner','$15/month locked for life','Founding member badge','Early-access to new features','Priority support'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
            <R><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.card,border:'1px solid '+T.cardBorder}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:13,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>Partner</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$20<span style={{fontSize:16,color:T.textDim,fontWeight:600}}>{t('superLink.perMonth')}</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 4px',fontWeight:700}}>Full platform access</div><div style={{fontSize:12,color:T.textFaint,marginBottom:20}}>Cancel anytime · No hidden fees</div>{['The full SuperAdPro platform','50% recurring commissions','8×8 Profit Grid','Creative Studio + Brand Posters','MyLeads CRM','Campaign Studio','Course Academy','AI-powered tools'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
          </div>
        </div>
      </section>
