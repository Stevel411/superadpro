        ...
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <R delay={0.3}><div style={{marginTop:40,padding:'20px 24px',borderRadius:16,background:T.card,border:'1px solid '+T.cardBorder,maxWidth:620,margin:'40px auto 0'}}>
            <div style={{fontSize:14.5,color:T.textMuted,lineHeight:1.7}}>
              <strong style={{color:T.strong}}>The bit nobody says:</strong> joining is free, and your sponsor earns nothing from your signup. Nobody makes money from you joining — the earning is on the advertising side, and only when you own a pack yourself.
            </div>
          </div></R>
        </div>
      </section>
      ...
      <section style={{...sec,background:T.grad2}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{maxWidth:380,margin:'48px auto 0'}}>
            <R><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.card,border:'1px solid '+T.cardBorder}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:13,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>Free to join</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>Free<span style={{fontSize:16,color:T.textDim,fontWeight:600}}> to join</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 4px',fontWeight:700}}>Every tool included</div><div style={{fontSize:12,color:T.textFaint,marginBottom:20}}>Nothing to pay · No subscription · No renewal</div>{['The full AdvantageLife toolkit','Page Builder & hosting','Email Marketing','My Blog & custom domain','Link Hub & Link Tools','Lead Finder & ProSeller','All marketing materials'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
          </div>
        </div>
      </section>
