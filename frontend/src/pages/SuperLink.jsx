    ...
    <div style={{ background: T.bg, color: T.text, fontFamily: "'DM Sans',sans-serif", minHeight: '100vh' }}>
      ...
      <section style={{ ...sec, minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 820, textAlign: 'center' }}>
          ...
          <R delay={0.4}><div><a href="/register" style={cta}>{t('superLink.createFreeAccount')}</a><div style={{fontSize:13,color:T.textFaint,marginTop:14}}>Free to join · No credit card · 60 seconds</div></div></R>
      ...
      <section style={{...sec,background:T.grad1}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <R delay={0.2}><div style={{marginTop:60,borderRadius:24,overflow:'hidden',border:'1px solid '+T.cardBorder,background:T.gridBg}}><div style={{textAlign:'center',padding:'24px 20px 0'}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:'clamp(18px,3vw,24px)',fontWeight:900,color:T.gridText}}>Watch Your <span style={{color:T.gridAccent}}>Profit Grid</span> Build</div><p style={{fontSize:13,color:'rgba(200,220,255,0.4)',marginTop:6}}>{t("superLink.selectTierDesc")}</p></div><div style={{height:380,padding:'8px 16px 16px'}}><Suspense fallback={<div style={{height:380,display:'flex',alignItems:'center',justifyContent:'center',color:T.gridAccent,fontFamily:"'Sora',sans-serif",fontSize:14,fontWeight:700}}>Loading 3D Grid...</div>}><IncomeGrid3D height={360} showControls autoPlay /></Suspense></div></div></R>
        </div>
      </section>
      ...
      <section style={{...sec,background:T.grad2}}>
        <div style={{maxWidth:960,margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:24,maxWidth:680,margin:'48px auto 0'}}>
            <R><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.card,border:'1px solid '+T.cardBorder}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:11,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>{t('superLink.basic')}</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$20<span style={{fontSize:16,color:T.textDim,fontWeight:600}}>/mo</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 20px'}}>All the essentials</div>{['Your SuperLink','50% recurring commissions','8×8 Profit Grid','Campaign Studio','LinkHub + Link Tools','Course Marketplace','Training Centre','Social Share Suite'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
            <R delay={0.1}><div style={{padding:'40px 28px',borderRadius:24,textAlign:'center',background:T.popBg,border:'1px solid '+T.popBorder,position:'relative'}}><div style={{position:'absolute',top:-1,left:'50%',transform:'translateX(-50%)',background:T.popBadge,color:'#fff',fontFamily:"'Sora',sans-serif",fontSize:9,fontWeight:800,letterSpacing:2,padding:'4px 16px',borderRadius:'0 0 8px 8px'}}>POPULAR</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:11,fontWeight:800,letterSpacing:2,textTransform:'uppercase',color:T.textDim,marginBottom:6}}>{t('superLink.pro')}</div><div style={{fontFamily:"'Sora',sans-serif",fontSize:52,fontWeight:900,color:T.heading,lineHeight:1}}>$35<span style={{fontSize:16,color:T.textDim,fontWeight:600}}>/mo</span></div><div style={{fontSize:13,color:T.textDim,margin:'6px 0 20px'}}>Full AI automation</div>{['Everything in Basic','AI Content Creator','AI Funnel Generator','SuperPages builder','Email Autoresponder','Lead Dashboard','Priority support'].map(function(f,i){return<div key={i} style={{fontSize:13,color:T.textMuted,padding:'7px 0',textAlign:'left',borderBottom:'1px solid '+T.featBorder}}><span style={{color:T.check,fontWeight:800}}>✓</span> {f}</div>})}</div></R>
          </div>
        </div>
      </section>
      ...
      <section style={{...sec,textAlign:'center',padding:'80px 24px'}}>
        ...
        <div style={{maxWidth:960,margin:'0 auto',position:'relative'}}>
          ...
          <R delay={0.15}><div><a href="/register" style={cta}>{t('superLink.createFreeAccount')}</a><div style={{fontSize:13,color:T.textFaint,marginTop:14}}>Free · No credit card · Cancel anytime</div></div></R>
        </div>
      </section>
