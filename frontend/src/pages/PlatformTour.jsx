...
export default function PlatformTour() {
  ...
  return (
    <AppLayout title="Platform Tour" subtitle="Your complete guide to SuperAdPro">
      ...
      {/* Sticky jump nav — sticks within AppLayout scroll container */}
      <div style={{ position: 'sticky', top: -24, zIndex: 10, background: '#f0f3f9', margin: '-24px -24px 16px -24px', padding: '16px 24px 12px', borderBottom: '1px solid #e2e8f0' }}>
