...
/* ── sidebar ── */
.al .side{background:#0a1f52;border-radius:22px;padding:20px 14px;box-shadow:0 24px 50px -24px rgba(10,31,82,.6);display:flex;flex-direction:column}
...
.al .side .grphead.matrix{background:rgba(37,99,235,.28);border-color:rgba(59,130,246,.6);box-shadow:inset 3px 0 0 #3b82f6}
.al .side .grphead.p2p{background:rgba(56,189,248,.22);border-color:rgba(103,209,251,.6);box-shadow:inset 3px 0 0 #38bdf8}
.al .side .grphead.mkt{background:rgba(13,148,136,.24);border-color:rgba(45,212,191,.6);box-shadow:inset 3px 0 0 #2dd4bf}
.al .side .grphead.matrix .gh,.al .side .grphead.p2p .gh,.al .side .grphead.mkt .gh{color:#fff}
.al .side .grpsub.matrix a{background:rgba(37,99,235,.24);border-color:rgba(59,130,246,.45);box-shadow:inset 3px 0 0 #3b82f6}
.al .side .grpsub.p2p a{background:rgba(56,189,248,.20);border-color:rgba(103,209,251,.45);box-shadow:inset 3px 0 0 #38bdf8}
.al .side .grpsub.mkt a{background:rgba(13,148,136,.22);border-color:rgba(45,212,191,.45);box-shadow:inset 3px 0 0 #2dd4bf}
...
.al .hero .ebreak{display:flex;gap:12px;flex-wrap:wrap;margin:16px 0 4px}
.al .hero .ecard{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);border-radius:13px;padding:12px 18px;min-width:150px}
.al .hero .ecard .et{display:flex;align-items:center;gap:7px;font-size:12px;font-weight:800;color:rgba(255,255,255,.75);text-transform:uppercase;letter-spacing:.5px}
.al .hero .ecard .ev{font-size:26px;font-weight:900;color:#34d17f;letter-spacing:-.5px;margin-top:3px}
.al .hero .big{font-weight:900;font-size:clamp(48px,6.4vw,70px);letter-spacing:-3px;line-height:1.03;color:#34d17f}
