...
export default function AnalyticsPage() {
  ...
  if (loading) return <AppLayout title="Analytics"><div style={{display:'flex',alignItems:'center',justifyContent:'center',padding:80}}><div style={{fontFamily:"'Sora',sans-serif",fontSize:16,fontWeight:700,color:'#64748b'}}>Loading analytics...</div></div></AppLayout>;
  ...
  var t = data.totals;
  var empty = function(msg) { return <div style={{height:280,display:'flex',alignItems:'center',justifyContent:'center',color:'#64748b',fontSize:14}}>{msg}</div>; };
