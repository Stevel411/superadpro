...
- **Currently used: 85/100** (was 77 when first email sent; 84 after Stripe annual went live; checking at session-end shows 85). Email + Facebook post drove the bump.
