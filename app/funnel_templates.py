...
def affiliate_recruit_template():
    ...
    y += 90
    # Features
    els.append({'id':_uid(),'type':'text','x':100,'y':y,'w':900,'h':220,'txt':'<div style="font-family:Sora,sans-serif;font-weight:700;font-size:18px;color:#fff;margin-bottom:16px;text-align:center">What You Get as a Member:</div><div style="display:flex;gap:10px;padding:10px 0;font-size:14px;color:#94a3b8;border-top:1px solid rgba(255,255,255,0.05)"><span style="color:#0ea5e9;font-weight:700">✓</span> 50% commission on every referral — every month</div><div style="display:flex;gap:10px;padding:10px 0;font-size:14px;color:#94a3b8;border-top:1px solid rgba(255,255,255,0.05)"><span style="color:#0ea5e9;font-weight:700">✓</span> 8-tier income grid — 100% of commissions paid to affiliates</div><div style="display:flex;gap:10px;padding:10px 0;font-size:14px;color:#94a3b8;border-top:1px solid rgba(255,255,255,0.05)"><span style="color:#0ea5e9;font-weight:700">✓</span> AI-powered marketing suite — funnels, emails, social posts</div><div style="display:flex;gap:10px;padding:10px 0;font-size:14px;color:#94a3b8;border-top:1px solid rgba(255,255,255,0.05)"><span style="color:#0ea5e9;font-weight:700">✓</span> Course marketplace with pass-up commissions up to $500</div><div style="display:flex;gap:10px;padding:10px 0;font-size:14px;color:#94a3b8;border-top:1px solid rgba(255,255,255,0.05)"><span style="color:#0ea5e9;font-weight:700">✓</span> Watch to Earn — get paid to watch member campaigns</div>','s':{}})
    y += 250
    # Disclaimer
