...
# ── RETIRED MATRIX PAYOUT CODE REMOVED 30 May 2026 ──────────────────
# find_next_available_position, place_in_matrix, pay_matrix_commissions,
# complete_matrix and the DIRECT_RATE (0.15) / SPILLOVER_RATE (0.10)
# constants were deleted. Credit packs now pay a FLAT 20% to the direct
# sponsor only (FLAT_REFERRAL_RATE, used in purchase_credit_pack). The
# get_* functions below still serve the read/display layer.
